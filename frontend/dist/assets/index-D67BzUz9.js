...
${e("detail.modalDisclaimer","This document is a prototype draft generated automatically for governance simulation and review by the Bhoomi Sakha Early Delay Warning System. It does NOT constitute an official legal or statutory order unless vetted, approved, and officially signed by the District Collector and gazetted under the relevant state and central legislation.")}`;o.innerHTML=`
  ...
  `;const r=()=>{n.innerHTML=""};n.querySelector("#closeModalBtn").addEventListener("click",r),n.querySelector("#cancelModalBtn").addEventListener("click",r),n.querySelector("#rejectDocForm").addEventListener("submit",async o=>{o.preventDefault();const c=n.querySelector("#rejectionReasonText").value.trim(),d=n.querySelector("#submitRejectBtn");d.disabled=!0,d.textContent="Rejecting...";try{await R.verifyDocument(t,a,{actor_user_id:s.user_id,verification_status:"rejected",rejection_reason:c}),r(),i()}catch(p){alert("Failed to reject document: "+p.message),d.disabled=!1,d.textContent="Confirm Rejection"}})}function H(t){return t?String(t).replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;").replace(/</g,"&lt;").replace(/>/g,"&gt;"):""}function Dt(t,{mode:a="login",initialRole:s="citizen",onAuthSuccess:n=null}={}){let i=s,r=a,l=!1,o=!1,c="";const d={name:"",email:"",password:"",district:"Pune",phone:"",officerKey:""};function p(){t.innerHTML=`
    ...
    `;const r=document.getElementById("userProfileBtn"),l=document.getElementById("userProfileDropdown"),o=document.getElementById("headerSignOutBtn");r&&l&&(r.addEventListener("click",c=>{c.stopPropagation(),!l.classList.contains("hidden")?(l.classList.add("hidden"),r.setAttribute("aria-expanded","false")):(l.classList.remove("hidden"),r.setAttribute("aria-expanded","true"))}),document.addEventListener("click",c=>{!r.contains(c.target)&&!l.contains(c.target)&&(l.classList.add("hidden"),r.setAttribute("aria-expanded","false"))})),o&&o.addEventListener("click",async()=>{j.disconnect(),await A.logout(),this.currentPortal="citizen",this.showToast(e("auth.signedOutToast","Signed out successfully."),"info"),this.updateUserSessionUI(),this.updateShellVisibility(!1),window.location.hash="#/login",this.handleRouting()})}setupPortalSwitcher(){const a=document.getElementById("switchToOfficerBtn"),s=document.getElementById("switchToCitizenBtn");a&&a.addEventListener("click",()=>{const n=A.getStoredUser();if(n&&n.role==="citizen"){this.showToast(e("auth.officerAccessDenied","Unauthorized: Officer portal access denied for citizen accounts."),"warning");return}this.currentPortal!=="officer"&&this.setPortalMode("officer",!0)}),s&&s.addEventListener("click",()=>{this.currentPortal!=="citizen"&&this.setPortalMode("citizen",!0)}),this.renderPortalNavigation()}setPortalMode(a,s=!1){const n=A.getStoredUser();if(n&&n.role==="citizen"&&a==="officer"){this.showToast(e("auth.officerAccessDenied","Unauthorized: Officer portal access denied for citizen accounts."),"warning");return}this.currentPortal=a;const i=document.getElementById("switchToOfficerBtn"),r=document.getElementById("switchToCitizenBtn");i&&r&&(a==="officer"?(i.className="px-2 py-1 rounded transition-all flex items-center gap-1 bg-primary text-on-primary shadow-xs font-semibold",r.className="px-2 py-1 rounded transition-all flex items-center gap-1 text-on-surface-variant hover:text-on-surface"):(r.className="px-2 py-1 rounded transition-all flex items-center gap-1 bg-primary text-on-primary shadow-xs font-semibold",i.className="px-2 py-1 rounded transition-all flex items-center gap-1 text-on-surface-variant hover:text-on-surface"));const l=document.getElementById("breadcrumbRoot");l&&(l.textContent=a==="officer"?e("header.commandCenter","Command Center"):e("citizen.portalTitle","Citizen Portal")),this.updateUserSessionUI(),this.renderPortalNavigation(),s&&(a==="officer"?window.location.hash="#/dashboard":window.location.hash="#/citizen-dashboard")}renderPortalNavigation(){const a=document.getElementById("mainNavigation"),s=document.getElementById("mobileNavigationMenu");!a||!s||(this.currentPortal==="citizen"?(a.innerHTML=`
