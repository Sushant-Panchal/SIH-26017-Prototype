(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function a(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(n){if(n.ep)return;n.ep=!0;const r=a(n);fetch(n.href,r)}})();const L={low:{id:"preset-low",name:"NH-44 Bypass Ph. 2",subtitle:"Low Delay • Clear Title",tag:"LOW RISK",values:{project_type:"Highway",land_type:"Agricultural",priority:"Normal",current_stage:"Notification",complexity_score:22.4,total_parcels:350,affected_families:48,land_area_hectares:65.2,planned_duration_days:420,days_since_notification:45,days_elapsed:45,days_in_current_stage:45,planned_stage_duration_days:60,acquisition_progress_pct:88.5,acquisition_velocity_pct_per_30d:14.8,parcels_pending:40,parcels_acquired:310,possession_pending_parcels:25,possession_progress_pct:92.8,documents_required:350,documents_pending:18,documents_verified:332,documentation_completion_pct:94.9,compensation_pending_cases:12,compensation_pending_amount:3.5,compensation_completion_pct:96.2,avg_compensation_delay_days:8,approvals_pending:1,overdue_approvals:0,avg_approval_delay_days:4,pending_objections:1,active_legal_disputes:0,ownership_disputes:0,court_stay_cases:0,rr_pending_cases:4,rr_completion_pct:94,schedule_variance_days:-12,milestones_overdue:0,pending_stakeholder_actions:2,avg_stakeholder_response_days:5.2,stakeholder_responsiveness_score:8.9,historical_avg_delay_days:14}},medium:{id:"preset-medium",name:"Western Freight Corridor",subtitle:"Baseline Model • FY26-Q1",tag:"MEDIUM RISK",values:{project_type:"Highway",land_type:"Agricultural",priority:"Normal",current_stage:"Notification",complexity_score:47.7,total_parcels:233,affected_families:113,land_area_hectares:132.47,planned_duration_days:607,days_since_notification:30,days_elapsed:30,days_in_current_stage:30,planned_stage_duration_days:26,acquisition_progress_pct:6.01,acquisition_velocity_pct_per_30d:6.13,parcels_pending:219,parcels_acquired:14,possession_pending_parcels:218,possession_progress_pct:6.47,documents_required:241,documents_pending:232,documents_verified:9,documentation_completion_pct:3.73,compensation_pending_cases:105,compensation_pending_amount:10.95,compensation_completion_pct:6.2,avg_compensation_delay_days:52.68,approvals_pending:5,overdue_approvals:2,avg_approval_delay_days:41.04,pending_objections:0,active_legal_disputes:0,ownership_disputes:0,court_stay_cases:0,rr_pending_cases:47,rr_completion_pct:4.08,schedule_variance_days:-7.19,milestones_overdue:1,pending_stakeholder_actions:7,avg_stakeholder_response_days:28.59,stakeholder_responsiveness_score:5.14,historical_avg_delay_days:100.8}},high:{id:"preset-high",name:"Docs Backlog Ph. 1",subtitle:"High Bottleneck • Stagnation Watchlist",tag:"HIGH RISK",values:{project_type:"Railway",land_type:"Commercial",priority:"Critical",current_stage:"Survey",complexity_score:68.5,total_parcels:1120,affected_families:420,land_area_hectares:210.5,planned_duration_days:900,days_since_notification:180,days_elapsed:180,days_in_current_stage:90,planned_stage_duration_days:60,acquisition_progress_pct:35,acquisition_velocity_pct_per_30d:2.5,parcels_pending:728,parcels_acquired:392,possession_pending_parcels:610,possession_progress_pct:28,documents_required:1120,documents_pending:580,documents_verified:540,documentation_completion_pct:48.2,compensation_pending_cases:240,compensation_pending_amount:42.6,compensation_completion_pct:38.5,avg_compensation_delay_days:72,approvals_pending:6,overdue_approvals:3,avg_approval_delay_days:65,pending_objections:18,active_legal_disputes:5,ownership_disputes:4,court_stay_cases:1,rr_pending_cases:85,rr_completion_pct:32,schedule_variance_days:54,milestones_overdue:3,pending_stakeholder_actions:9,avg_stakeholder_response_days:38,stakeholder_responsiveness_score:3.8,historical_avg_delay_days:95}},critical:{id:"preset-critical",name:"Court Injunction HC",subtitle:"Critical Hold • High Court Stay Active",tag:"CRITICAL RISK",values:{project_type:"Metro",land_type:"Industrial",priority:"Critical",current_stage:"Compensation",complexity_score:84,total_parcels:850,affected_families:610,land_area_hectares:184.2,planned_duration_days:1200,days_since_notification:360,days_elapsed:360,days_in_current_stage:180,planned_stage_duration_days:90,acquisition_progress_pct:22,acquisition_velocity_pct_per_30d:.8,parcels_pending:663,parcels_acquired:187,possession_pending_parcels:620,possession_progress_pct:18,documents_required:850,documents_pending:640,documents_verified:210,documentation_completion_pct:24.7,compensation_pending_cases:380,compensation_pending_amount:85.4,compensation_completion_pct:18,avg_compensation_delay_days:118,approvals_pending:9,overdue_approvals:6,avg_approval_delay_days:98,pending_objections:42,active_legal_disputes:14,ownership_disputes:8,court_stay_cases:4,rr_pending_cases:140,rr_completion_pct:14,schedule_variance_days:145,milestones_overdue:6,pending_stakeholder_actions:14,avg_stakeholder_response_days:52,stakeholder_responsiveness_score:2.1,historical_avg_delay_days:135}}},I=[{id:"BF-NH-2024-09",name:"Delhi-Amritsar Expressway (Pkg 4)",type:"Highway",sector:"National Highway",district:"Ludhiana",state:"Punjab",stage:"Sec 19 Declaration",progressPct:42,delayProbability:84.6,riskLevel:"CRITICAL",badgeClass:"bg-error-container text-on-error-container",presetKey:"critical"},{id:"BF-RL-2023-14",name:"Western Dedicated Freight Corridor",type:"Railway",sector:"Freight Rail Corridor",district:"Vadodara",state:"Gujarat",stage:"Compensation Award",progressPct:68,delayProbability:71.2,riskLevel:"HIGH",badgeClass:"bg-secondary-fixed text-on-secondary-fixed-variant",presetKey:"high"},{id:"BF-EN-2024-03",name:"Bhadla Solar Ultra Park Ext",type:"Power",sector:"Renewable Energy Grid",district:"Jodhpur",state:"Rajasthan",stage:"Joint Survey 3A",progressPct:31,delayProbability:58.4,riskLevel:"MEDIUM",badgeClass:"bg-amber-100 text-amber-900 border border-amber-300",presetKey:"medium"},{id:"BF-NH-2024-22",name:"NH-66 Coastal Highway Expansion",type:"Highway",sector:"National Highway",district:"Udupi",state:"Karnataka",stage:"Notification",progressPct:54,delayProbability:42.3,riskLevel:"MEDIUM",badgeClass:"bg-amber-100 text-amber-900 border border-amber-300",presetKey:"medium"},{id:"BF-MT-2024-05",name:"Pune Metro Line 3 Corridor",type:"Metro",sector:"Urban Mass Transit",district:"Pune",state:"Maharashtra",stage:"Rehabilitation",progressPct:79,delayProbability:34.8,riskLevel:"LOW",badgeClass:"bg-emerald-100 text-emerald-900 border border-emerald-300",presetKey:"low"},{id:"BF-IN-2024-18",name:"Dholera Special Investment Region Ph 1",type:"Industrial",sector:"Industrial Node / SEZ",district:"Ahmedabad",state:"Gujarat",stage:"Valuation",progressPct:62,delayProbability:46.1,riskLevel:"MEDIUM",badgeClass:"bg-amber-100 text-amber-900 border border-amber-300",presetKey:"medium"}];function W(t){return typeof t!="number"||isNaN(t)?0:t>1?t/100:Math.max(0,t)}function g(t){const e=W(t);return e>=.8?"CRITICAL":e>=.6?"HIGH":e>=.4?"MEDIUM":"LOW"}function z(t){switch(typeof t=="string"?t.toUpperCase():g(t)){case"CRITICAL":return"Critical predicted delay risk";case"HIGH":return"High predicted delay risk";case"MEDIUM":return"Moderate predicted delay risk";case"LOW":default:return"Low predicted delay risk"}}function V(t){switch(typeof t=="string"?t.toUpperCase():g(t)){case"CRITICAL":return"Critical predicted delay risk based on the current project snapshot.";case"HIGH":return"High predicted delay risk based on the current project snapshot.";case"MEDIUM":return"Moderate predicted delay risk based on the current project snapshot.";case"LOW":default:return"Low predicted delay risk based on the current project snapshot."}}function Y(t){switch(typeof t=="string"?t.toUpperCase():g(t)){case"CRITICAL":return"Risk Level: CRITICAL (Threshold ≥ 80%)";case"HIGH":return"Risk Level: HIGH (Threshold: 60% – 79.9%)";case"MEDIUM":return"Risk Level: MEDIUM (Threshold: 40% – 59.9%)";case"LOW":default:return"Risk Level: LOW (Threshold < 40%)"}}function E(t){switch(typeof t=="string"?t.toUpperCase():g(t)){case"CRITICAL":return"bg-red-100 text-red-900 border-red-300 dark:bg-red-950/60 dark:text-red-300 dark:border-red-800";case"HIGH":return"bg-orange-100 text-orange-900 border-orange-300 dark:bg-orange-950/60 dark:text-orange-300 dark:border-orange-800";case"MEDIUM":return"bg-amber-100 text-amber-900 border-amber-300 dark:bg-amber-950/60 dark:text-amber-300 dark:border-amber-800";case"LOW":default:return"bg-emerald-100 text-emerald-900 border-emerald-300 dark:bg-emerald-950/60 dark:text-emerald-300 dark:border-emerald-800"}}function j(t){switch(typeof t=="string"?t.toUpperCase():g(t)){case"CRITICAL":return"text-red-600 dark:text-red-400";case"HIGH":return"text-orange-600 dark:text-orange-400";case"MEDIUM":return"text-amber-600 dark:text-amber-400";case"LOW":default:return"text-emerald-600 dark:text-emerald-400"}}function J(t){switch(typeof t=="string"?t.toUpperCase():g(t)){case"CRITICAL":return"text-red-600 dark:text-red-500";case"HIGH":return"text-orange-500 dark:text-orange-400";case"MEDIUM":return"text-amber-500 dark:text-amber-400";case"LOW":default:return"text-emerald-500 dark:text-emerald-400"}}function Q(t,e,a){t.innerHTML=`
  ...
  `;const s=t.querySelector("#projectSearchInput"),n=t.querySelector("#projectsTableBody");s&&n&&s.addEventListener("input",d=>{const c=d.target.value.toLowerCase().trim(),u=I.filter(p=>p.id.toLowerCase().includes(c)||p.name.toLowerCase().includes(c)||p.district.toLowerCase().includes(c)||p.state.toLowerCase().includes(c));n.innerHTML=$(u),O(t,e,a)});const r=t.querySelector("#openAssessmentCtaBtn"),o=t.querySelector("#jumpToAssessmentBtn");r&&e&&r.addEventListener("click",()=>e("medium")),o&&e&&o.addEventListener("click",()=>e("high")),O(t,e,a)}function $(t){return t.length===0?'<tr><td colspan="7" class="text-center py-4 text-on-surface-variant">No matching projects found.</td></tr>':t.map(e=>`
  ...
  `).join("")}function O(t,e,a){t.querySelectorAll(".assess-project-btn").forEach(s=>{s.addEventListener("click",()=>{const n=s.getAttribute("data-preset")||"medium";e&&e(n)})}),t.querySelectorAll(".audit-project-btn").forEach(s=>{s.addEventListener("click",()=>{const n=s.getAttribute("data-id");a&&a(n)})})}const K="http://127.0.0.1:8000";class R extends Error{constructor(e,a=null,s=null){super(e),this.name="ApiError",this.status=a,this.details=s}}async function F(t,e={}){const a=`${K}${t}`,s=new AbortController,n=setTimeout(()=>s.abort(),e.timeout||15e3),r={"Content-Type":"application/json",Accept:"application/json"};try{const o=await fetch(a,{...e,headers:{...r,...e.headers||{}},signal:s.signal});clearTimeout(n);const d=o.headers.get("content-type")||"";let c=null;if(d.includes("application/json")?c=await o.json():c=await o.text(),!o.ok){const u=c&&typeof c=="object"&&c.detail?c.detail:`Request failed with status ${o.status}`;throw new R(u,o.status,c)}return c}catch(o){throw clearTimeout(n),o instanceof R?o:o.name==="AbortError"?new R("Request timed out while contacting Bhoomi Sakha prediction engine.",408):(console.debug(`[ApiClient] Network request failed for ${t}:`,o),new R("Prediction service is temporarily unavailable. Please try again.",0,o))}}const B={baseUrl:K,get(t,e={}){return F(t,{...e,method:"GET"})},post(t,e,a={}){return F(t,{...a,method:"POST",body:JSON.stringify(e)})}},q={async checkHealth(){try{const t=await B.get("/health",{timeout:4e3});return{online:t.status==="healthy",modelLoaded:!!t.model_loaded,featureCount:t.features||76,raw:t}}catch(t){return{online:!1,modelLoaded:!1,featureCount:0,error:t.message}}},async getMetadata(){return B.get("/meta")},async predictRisk(t){return B.post("/predict",t)}};let T={activePreset:"medium",lastPrediction:null,isLoading:!1};function X(t,e="medium"){T.activePreset=e;const a=L[e]||L.medium;t.innerHTML=`
    <div class="flex flex-col w-full">
  ...
  `,Z(t,a)}function Z(t,e){D(e.values),C(),t.querySelectorAll(".preset-pill").forEach(i=>{i.addEventListener("click",()=>{const b=i.getAttribute("data-preset");t.querySelectorAll(".preset-pill").forEach(f=>{f.classList.remove("bg-surface-container-high","ring-1","ring-secondary"),f.classList.add("bg-surface-container-low")}),i.classList.remove("bg-surface-container-low"),i.classList.add("bg-surface-container-high","ring-1","ring-secondary");const l=L[b];l&&(T.activePreset=b,D(l.values),C(),S(t))})});const a=t.querySelector("#field_docsPending"),s=t.querySelector("#field_docsReq");a&&a.addEventListener("input",C),s&&s.addEventListener("input",C);const n=t.querySelector("#runPredictionBtn");n&&n.addEventListener("click",()=>S(t));const r=t.querySelector("#resetScenarioBtn"),o=t.querySelector("#resetFormBtn"),d=()=>{const i=L[T.activePreset]||L.medium;D(i.values),C(),S(t)};r&&r.addEventListener("click",d),o&&o.addEventListener("click",d);const c=t.querySelector("#transparencyAccordionBtn"),u=t.querySelector("#transparencyContent"),p=t.querySelector("#accordionChevron");c&&u&&c.addEventListener("click",()=>{u.classList.contains("hidden")?(u.classList.remove("hidden"),p.style.transform="rotate(180deg)"):(u.classList.add("hidden"),p.style.transform="rotate(0deg)")}),S(t)}function C(){var r,o;const t=parseFloat((r=document.getElementById("field_docsReq"))==null?void 0:r.value)||1,e=parseFloat((o=document.getElementById("field_docsPending"))==null?void 0:o.value)||0,a=Math.max(0,Math.min(100,(t-e)/t*100)).toFixed(1),s=document.getElementById("label_docCompletion"),n=document.getElementById("bar_docCompletion");s&&(s.textContent=`${a}%`),n&&(n.style.width=`${a}%`)}function D(t){if(!t)return;const e=(a,s)=>{const n=document.getElementById(a);n&&s!==void 0&&(n.value=s)};e("field_projectType",t.project_type||"Highway"),e("field_landType",t.land_type||"Agricultural"),e("field_priority",t.priority||"Normal"),e("field_complexity",t.complexity_score??47.7),e("field_totalParcels",t.total_parcels??233),e("field_affectedFamilies",t.affected_families??113),e("field_landArea",t.land_area_hectares??132.5),e("field_plannedDuration",t.planned_duration_days??607),e("field_acqProgress",t.acquisition_progress_pct??6),e("field_velocity",t.acquisition_velocity_pct_per_30d??6.13),e("field_parcelsPending",t.parcels_pending??219),e("field_possessionPending",t.possession_pending_parcels??218),e("field_docsReq",t.documents_required??241),e("field_docsPending",t.documents_pending??232),e("field_compCases",t.compensation_pending_cases??105),e("field_compAmount",t.compensation_pending_amount??10.95),e("field_compDisbursed",t.compensation_completion_pct??6.2),e("field_apprPending",t.approvals_pending??5),e("field_apprOverdue",t.overdue_approvals??2),e("field_apprDelay",t.avg_approval_delay_days??41),e("field_pendingObj",t.pending_objections??0),e("field_activeDisputes",t.active_legal_disputes??0),e("field_ownerDisputes",t.ownership_disputes??0),e("field_courtStays",t.court_stay_cases??0),e("field_rrPending",t.rr_pending_cases??47),e("field_rrCompletion",t.rr_completion_pct??4.08),e("field_schedVariance",t.schedule_variance_days??-7.19),e("field_milestonesOverdue",t.milestones_overdue??1),e("field_shActions",t.pending_stakeholder_actions??7),e("field_shResponse",t.avg_stakeholder_response_days??28.59),e("field_shScore",t.stakeholder_responsiveness_score??5.14),e("field_histDelay",t.historical_avg_delay_days??100.8)}function ee(){var l;const t=(f,v=0)=>{var w;const x=parseFloat((w=document.getElementById(f))==null?void 0:w.value);return isNaN(x)?v:Math.max(0,x)},e=(f,v=0)=>{var w;const x=parseInt((w=document.getElementById(f))==null?void 0:w.value,10);return isNaN(x)?v:Math.max(0,x)},a=(f,v="")=>{var x;return((x=document.getElementById(f))==null?void 0:x.value)||v},s=e("field_totalParcels",200),n=e("field_parcelsPending",50),r=Math.max(0,s-n),o=e("field_docsReq",200),d=e("field_docsPending",50),c=Math.max(0,o-d),u=o>0?Math.min(100,Math.max(0,c/o*100)):0,p=e("field_compCases",10),i=t("field_compAmount",10),b=Math.min(100,t("field_compDisbursed",50));return{project_type:a("field_projectType","Highway"),land_type:a("field_landType","Mixed"),priority:a("field_priority","Normal"),current_stage:"Survey",complexity_score:t("field_complexity",40),total_parcels:s,parcels_pending:n,parcels_acquired:r,affected_families:t("field_affectedFamilies",50),land_area_hectares:t("field_landArea",100),planned_duration_days:e("field_plannedDuration",600),days_since_notification:30,days_elapsed:30,days_in_current_stage:30,planned_stage_duration_days:30,schedule_variance_days:parseFloat((l=document.getElementById("field_schedVariance"))==null?void 0:l.value)||0,milestones_due:2,milestones_completed:1,milestones_overdue:e("field_milestonesOverdue",0),acquisition_progress_pct:Math.min(100,t("field_acqProgress",50)),acquisition_velocity_pct_per_30d:t("field_velocity",5),possession_progress_pct:Math.min(100,(1-e("field_possessionPending",50)/Math.max(1,s))*100),possession_pending_parcels:e("field_possessionPending",50),compensation_total_amount:i*1.5,compensation_assessed_amount:i*1.2,compensation_disbursed_amount:i*.5,compensation_pending_amount:i,compensation_completion_pct:b,compensation_pending_cases:p,avg_compensation_delay_days:p*.5,documents_required:o,documents_verified:c,documents_pending:d,documentation_completion_pct:u,approvals_required:10,approvals_completed:5,approvals_pending:e("field_apprPending",2),approval_completion_pct:50,avg_approval_delay_days:t("field_apprDelay",10),overdue_approvals:e("field_apprOverdue",0),active_legal_disputes:e("field_activeDisputes",0),resolved_legal_disputes:0,ownership_disputes:e("field_ownerDisputes",0),court_stay_cases:e("field_courtStays",0),pending_objections:e("field_pendingObj",0),families_requiring_rr:e("field_rrPending",0)+10,families_rr_completed:10,rr_completion_pct:Math.min(100,t("field_rrCompletion",50)),rr_pending_cases:e("field_rrPending",0),pending_stakeholder_actions:e("field_shActions",0),avg_stakeholder_response_days:t("field_shResponse",10),stakeholder_responsiveness_score:t("field_shScore",5),interdepartmental_pending_actions:2,historical_avg_delay_days:t("field_histDelay",50)}}async function S(t){const e=t.querySelector("#loadingOverlay"),a=t.querySelector("#runPredictionBtn");e&&e.classList.remove("hidden"),a&&(a.disabled=!0,a.classList.add("opacity-70","cursor-not-allowed"));try{const s=ee(),n=await q.predictRisk(s);T.lastPrediction=n,te(t,n)}catch(s){console.error("Prediction failed:",s),ae(t,s.message)}finally{e&&e.classList.add("hidden"),a&&(a.disabled=!1,a.classList.remove("opacity-70","cursor-not-allowed"))}}function te(t,e){const a=e.delay_probability_pct!==void 0?e.delay_probability_pct:e.delay_probability!==void 0?e.delay_probability*100:0,s=typeof a=="number"&&!isNaN(a)?a:0,n=g(s),r=z(n),o=V(n),d=Y(n),c=t.querySelector("#probabilityValue"),u=t.querySelector("#probabilityCircle"),p=t.querySelector("#decisionOutcome"),i=t.querySelector("#riskBadge"),b=t.querySelector("#riskSummaryText"),l=t.querySelector("#riskThresholdNote");c&&(c.textContent=`${s.toFixed(2)}%`),p&&(p.textContent=r,p.className=`mt-1 font-label-sm text-[11px] font-semibold ${j(n)}`),b&&(b.textContent=o),l&&(l.textContent=d);const f=301.59,v=f-f*(Math.min(100,Math.max(0,s))/100);u&&(u.style.strokeDashoffset=v,u.className=`transition-all duration-700 ease-out ${J(n)}`),i&&(i.textContent=`${n} RISK`,i.className=`px-space-sm py-1 rounded font-label-sm text-label-sm font-bold uppercase tracking-wider border ${E(n)}`);const x=t.querySelector("#riskIncreasingContainer");if(x){const y=e.risk_drivers||[];if(y.length===0)x.innerHTML=`
      ...
      `;else{const k=Math.max(...y.map(m=>Math.abs(m.contribution)),.1);x.innerHTML=y.map(m=>{const A=Math.min(100,Math.max(15,Math.abs(m.contribution)/k*100)),N=m.contribution>.4?"bg-error":"bg-secondary-container";return`
          <div class="flex flex-col gap-1 border-b border-surface-container-high/40 pb-2 last:border-none">
            ...
            <div class="w-full bg-surface-container-high rounded-full h-2 overflow-hidden">
              <div class="${N} h-full rounded-full transition-all duration-700" style="width: ${A.toFixed(0)}%;"></div>
            </div>
      ...
      `;else{const k=Math.max(...y.map(m=>Math.abs(m.contribution)),.1);w.innerHTML=y.map(m=>{const A=Math.min(100,Math.max(15,Math.abs(m.contribution)/k*100));return`
          <div class="flex flex-col gap-1 border-b border-surface-container-high/40 pb-2 last:border-none">
            <div class="flex items-center justify-between font-label-sm text-label-sm">
            ...
            <div class="w-full bg-surface-container-high rounded-full h-2 overflow-hidden">
              <div class="bg-emerald-600 h-full rounded-full transition-all duration-700" style="width: ${A.toFixed(0)}%;"></div>
            </div>
          </div>
        `}).join("")}}const M=t.querySelector("#directivesContainer");if(M){const y=e.risk_drivers||[];y.length>0?M.innerHTML=y.slice(0,2).map((k,m)=>`
      ...
      `}}function ae(t,e){const a=t.querySelector("#riskIncreasingContainer"),s=e&&!e.includes("uvicorn")?e:"Prediction service is temporarily unavailable. Please try again.";if(a){a.innerHTML=`
    ...
    `;const n=a.querySelector("#retryPredictionBtn");n&&n.addEventListener("click",()=>S(t))}}function se(t,e,a){t.innerHTML=`
  ...
  `;const s=t.querySelector("#directoryTableBody"),n=t.querySelector("#directorySearchInput"),r=t.querySelector("#filterSector"),o=t.querySelector("#filterRisk"),d=()=>{const u=((n==null?void 0:n.value)||"").toLowerCase().trim(),p=(r==null?void 0:r.value)||"all",i=(o==null?void 0:o.value)||"all",b=I.filter(l=>{const f=l.id.toLowerCase().includes(u)||l.name.toLowerCase().includes(u)||l.district.toLowerCase().includes(u)||l.state.toLowerCase().includes(u),v=p==="all"||l.type===p,x=i==="all"||l.riskLevel===i;return f&&v&&x});if(b.length===0){s.innerHTML='<tr><td colspan="8" class="text-center py-6 text-on-surface-variant">No matching records found in national database.</td></tr>';return}s.innerHTML=b.map(l=>`
    ...
    `).join(""),s.querySelectorAll(".dir-assess-btn").forEach(l=>{l.addEventListener("click",()=>{const f=l.getAttribute("data-preset");e&&e(f)})}),s.querySelectorAll(".dir-audit-btn").forEach(l=>{l.addEventListener("click",()=>{const f=l.getAttribute("data-id");a&&a(f)})})};n&&n.addEventListener("input",d),r&&r.addEventListener("change",d),o&&o.addEventListener("change",d);const c=t.querySelector("#newAssessmentBtn");c&&e&&c.addEventListener("click",()=>e("medium")),d()}function ne(t,e="BF-NH-2024-09",a){const s=I.find(d=>d.id===e)||I[0],n=g(s.delayProbability);t.innerHTML=`
    <div class="flex flex-col w-full">
  ...
  `;const r=t.querySelector("#detailRerunBtn");r&&a&&r.addEventListener("click",()=>a(s.presetKey||"medium"));const o=t.querySelector("#backToProjectsBreadcrumb");o&&o.addEventListener("click",()=>{window.location.hash="#/projects"})}const U="bhoomi_notifications_read",H=[{id:"notif-crit-1",category:"Risk Alert",severity:"critical",title:"Critical delay risk detected in current assessment",summary:"Delhi-Amritsar Expressway (Pkg 4) evaluated with 84.6% delay probability requiring urgent Section 19 intervention.",timestamp:"15 mins ago",actionRoute:"#/assessment?preset=critical",actionLabel:"Inspect Assessment"},{id:"notif-engine-2",category:"Engine",severity:"info",title:"Backend prediction engine connected",summary:"FastAPI service connected with 76 engineered cadastral features ready for live XGBoost inference.",timestamp:"1 hour ago",actionRoute:"#/dashboard",actionLabel:"View Dashboard"},{id:"notif-atten-3",category:"Officer Attention",severity:"high",title:"Assessment contains factors requiring officer attention",summary:"18 high-bottleneck parcel cases in Western Freight Corridor flagged for documentation backlog review.",timestamp:"3 hours ago",actionRoute:"#/assessment?preset=high",actionLabel:"Review Factors"},{id:"notif-stat-4",category:"System",severity:"info",title:"Risk assessment pipeline initialized",summary:"National Cadastral Matrix synchronized with 142 monitored infrastructure corridors.",timestamp:"Today, 09:30 AM",actionRoute:"#/projects",actionLabel:"Projects Directory"}];class oe{constructor(){this.listeners=[]}getReadIds(){try{const e=localStorage.getItem(U);return e?JSON.parse(e):[]}catch{return[]}}saveReadIds(e){try{localStorage.setItem(U,JSON.stringify(e)),this.notifyListeners()}catch(a){console.error("Failed to save read notifications:",a)}}getAll(){const e=new Set(this.getReadIds());return H.map(a=>({...a,isRead:e.has(a.id)}))}getUnreadCount(){const e=new Set(this.getReadIds());return H.filter(a=>!e.has(a.id)).length}markAsRead(e){const a=new Set(this.getReadIds());a.add(e),this.saveReadIds(Array.from(a))}markAsUnread(e){const a=new Set(this.getReadIds());a.delete(e),this.saveReadIds(Array.from(a))}markAllAsRead(){const e=H.map(a=>a.id);this.saveReadIds(e)}resetAll(){this.saveReadIds([])}subscribe(e){return this.listeners.push(e),()=>{this.listeners=this.listeners.filter(a=>a!==e)}}notifyListeners(){const e=this.getUnreadCount();this.listeners.forEach(a=>a(e))}}const _=new oe;function re(t,e){let a="all";function s(){const n=_.getAll(),r=_.getUnreadCount(),o=a==="unread"?n.filter(i=>!i.isRead):n;t.innerHTML=`
    ...
    `;const d=t.querySelector("#markAllReadBtn");d&&d.addEventListener("click",()=>{_.markAllAsRead(),s(),e&&e()});const c=t.querySelector("#resetNotifsBtn");c&&c.addEventListener("click",()=>{_.resetAll(),s(),e&&e()});const u=t.querySelector("#filterAllBtn");u&&u.addEventListener("click",()=>{a="all",s()});const p=t.querySelector("#filterUnreadBtn");p&&p.addEventListener("click",()=>{a="unread",s()}),t.querySelectorAll(".toggle-read-btn").forEach(i=>{i.addEventListener("click",b=>{b.stopPropagation();const l=i.getAttribute("data-id"),f=_.getAll().find(v=>v.id===l);f!=null&&f.isRead?_.markAsUnread(l):_.markAsRead(l),s(),e&&e()})})}s()}const G="bhoomi_theme",h={SYSTEM:"system",LIGHT:"light",DARK:"dark"};class le{constructor(){this.mediaQuery=window.matchMedia("(prefers-color-scheme: dark)"),this.listeners=[],this.currentTheme=this.getStoredTheme()}init(){this.applyTheme(this.currentTheme),this.mediaQuery.addEventListener("change",()=>{this.currentTheme===h.SYSTEM&&this.applyTheme(h.SYSTEM)})}getStoredTheme(){try{const e=localStorage.getItem(G);if(e&&Object.values(h).includes(e))return e}catch{}return h.SYSTEM}getResolvedTheme(){return this.currentTheme===h.SYSTEM?this.mediaQuery.matches?h.DARK:h.LIGHT:this.currentTheme}setTheme(e){if(Object.values(h).includes(e)){this.currentTheme=e;try{localStorage.setItem(G,e)}catch(a){console.warn("Could not persist theme to localStorage:",a)}this.applyTheme(e),this.notifyListeners()}}applyTheme(e){const a=e===h.DARK||e===h.SYSTEM&&this.mediaQuery.matches,s=document.documentElement;a?s.classList.add("dark"):s.classList.remove("dark"),s.setAttribute("data-theme",e)}subscribe(e){return this.listeners.push(e),()=>{this.listeners=this.listeners.filter(a=>a!==e)}}notifyListeners(){this.listeners.forEach(e=>e(this.currentTheme,this.getResolvedTheme()))}}const P=new le;class ie{constructor(){this.container=document.getElementById("appViewContainer"),this.currentView="dashboard",this.isBackendOnline=!1,this.healthInterval=null,this.clockInterval=null}init(){P.init(),this.setupThemeToggle(),this.setupNavigation(),this.setupClock(),this.setupNotificationBell(),this.startHealthPolling(),this.handleRouting(),window.addEventListener("hashchange",()=>this.handleRouting());const e=document.getElementById("brandHeaderHome");e&&e.addEventListener("click",()=>{window.location.hash="#/dashboard"});const a=document.getElementById("backendStatusPill");a&&a.addEventListener("click",()=>this.checkBackendHealth(!0))}setupNotificationBell(){const e=document.getElementById("notifBellBtn");e&&e.addEventListener("click",()=>{window.location.hash="#/notifications"}),this.updateNotificationBadge(),_.subscribe(()=>this.updateNotificationBadge())}updateNotificationBadge(){const e=_.getUnreadCount(),a=document.getElementById("notifBellBadge"),s=document.getElementById("notifBellBtn");a&&(e>0?(a.textContent=e>9?"9+":e,a.classList.remove("hidden")):(a.textContent="",a.classList.add("hidden"))),s&&s.setAttribute("title",e>0?`${e} Unread System Notifications`:"No Unread Notifications")}setupThemeToggle(){const e=document.getElementById("themeToggleBtn"),a=document.getElementById("themeMenu"),s=document.getElementById("themeIcon"),n=document.querySelectorAll(".theme-option-btn"),r=o=>{const d={system:"brightness_auto",light:"light_mode",dark:"dark_mode"};s&&(s.textContent=d[o]||"brightness_auto"),n.forEach(c=>{const u=c.getAttribute("data-theme"),p=c.querySelector(".check-icon");u===o?(c.classList.add("bg-surface-container","font-semibold"),p&&p.classList.remove("hidden")):(c.classList.remove("bg-surface-container","font-semibold"),p&&p.classList.add("hidden"))})};r(P.currentTheme),P.subscribe(o=>r(o)),e&&a&&(e.addEventListener("click",o=>{o.stopPropagation(),!a.classList.contains("hidden")?(a.classList.add("hidden"),e.setAttribute("aria-expanded","false")):(a.classList.remove("hidden"),e.setAttribute("aria-expanded","true"))}),n.forEach(o=>{o.addEventListener("click",()=>{const d=o.getAttribute("data-theme");P.setTheme(d),a.classList.add("hidden"),e.setAttribute("aria-expanded","false")})}),document.addEventListener("click",o=>{!e.contains(o.target)&&!a.contains(o.target)&&(a.classList.add("hidden"),e.setAttribute("aria-expanded","false"))}),document.addEventListener("keydown",o=>{o.key==="Escape"&&!a.classList.contains("hidden")&&(a.classList.add("hidden"),e.setAttribute("aria-expanded","false"),e.focus())}))}setupNavigation(){const e=document.querySelectorAll(".nav-tab");e.forEach(a=>{a.addEventListener("click",s=>{e.forEach(n=>{n.className="nav-tab px-space-md py-1.5 font-label-md text-label-md text-on-surface-variant hover:text-on-surface hover:bg-surface-container transition-colors rounded",n.removeAttribute("aria-current")}),a.className="nav-tab px-space-md py-1.5 transition-colors bg-primary-container text-on-primary font-label-md rounded-lg shadow-sm font-semibold",a.setAttribute("aria-current","page")})})}updateNavState(e){document.querySelectorAll(".nav-tab").forEach(r=>{r.getAttribute("data-target")===e?(r.className="nav-tab px-space-md py-1.5 transition-colors bg-primary-container text-on-primary font-label-md rounded-lg shadow-sm font-semibold",r.setAttribute("aria-current","page")):(r.className="nav-tab px-space-md py-1.5 font-label-md text-label-md text-on-surface-variant hover:text-on-surface hover:bg-surface-container transition-colors rounded",r.removeAttribute("aria-current"))});const s={dashboard:"National Cadastral Matrix (Overview)",assessment:"Predictive Delay-Risk Assessment Cockpit",projects:"National Land Acquisition Projects Directory",audit:"Cadastral & Risk Detailed Dossier",notifications:"System Notifications & Operational Alerts"},n=document.getElementById("currentViewName");n&&(n.textContent=s[e]||"Executive Command Center")}handleRouting(){const e=window.location.hash||"#/dashboard",[a,s]=e.replace("#/","").split("?"),n=new URLSearchParams(s||"");switch(this.currentView=a||"dashboard",this.updateNavState(this.currentView),window.scrollTo({top:0,behavior:"smooth"}),this.currentView){case"notifications":re(this.container,()=>this.updateNotificationBadge());break;case"assessment":const r=n.get("preset")||"medium";X(this.container,r);break;case"projects":se(this.container,d=>{window.location.hash=`#/assessment?preset=${d}`},d=>{window.location.hash=`#/audit?id=${d}`});break;case"audit":const o=n.get("id")||"BF-NH-2024-09";ne(this.container,o,d=>{window.location.hash=`#/assessment?preset=${d}`});break;case"dashboard":default:this.currentView="dashboard",Q(this.container,d=>{window.location.hash=`#/assessment?preset=${d}`},d=>{window.location.hash=`#/audit?id=${d}`});break}}setupClock(){const e=()=>{const a=document.getElementById("liveISTClock");if(a){const s=new Date,n={timeZone:"Asia/Kolkata",hour12:!1,hour:"2-digit",minute:"2-digit",second:"2-digit"};a.textContent=s.toLocaleTimeString("en-GB",n)}};e(),this.clockInterval=setInterval(e,1e3)}async checkBackendHealth(e=!1){var r,o;const a=document.getElementById("backendStatusDot"),s=document.getElementById("backendStatusText");a&&(a.innerHTML='<span class="animate-pulse relative inline-flex rounded-full h-2 w-2 bg-amber-400"></span>'),s&&!this.isBackendOnline&&(s.textContent="Backend: Connecting...",s.className="font-label-sm text-label-sm text-on-surface-variant font-tabular-data");const n=await q.checkHealth();if(n.online&&n.modelLoaded){let d="FastAPI Connected • XGBoost Engine Active";try{this.cachedMetadata||(this.cachedMetadata=await q.getMetadata()),(o=(r=this.cachedMetadata)==null?void 0:r.model)!=null&&o.version&&(d=`FastAPI Connected • XGBoost Engine v${this.cachedMetadata.model.version} Active`)}catch{}a&&(a.innerHTML=`
    ...
    `,s.appendChild(n),requestAnimationFrame(()=>{n.classList.remove("translate-y-2","opacity-0")}),setTimeout(()=>{n.classList.add("opacity-0","translate-y-2"),setTimeout(()=>n.remove(),300)},4500)}}document.addEventListener("DOMContentLoaded",()=>{new ie().init()});
