(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function a(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(n){if(n.ep)return;n.ep=!0;const o=a(n);fetch(n.href,o)}})();const R={low:{id:"preset-low",name:"NH-44 Bypass Ph. 2",subtitle:"Low Delay • Clear Title",tag:"LOW RISK",values:{project_type:"Highway",land_type:"Agricultural",priority:"Normal",current_stage:"Notification",complexity_score:22.4,total_parcels:350,affected_families:48,land_area_hectares:65.2,planned_duration_days:420,days_since_notification:45,days_elapsed:45,days_in_current_stage:45,planned_stage_duration_days:60,acquisition_progress_pct:88.5,acquisition_velocity_pct_per_30d:14.8,parcels_pending:40,parcels_acquired:310,possession_pending_parcels:25,possession_progress_pct:92.8,documents_required:350,documents_pending:18,documents_verified:332,documentation_completion_pct:94.9,compensation_pending_cases:12,compensation_pending_amount:3.5,compensation_completion_pct:96.2,avg_compensation_delay_days:8,approvals_pending:1,overdue_approvals:0,avg_approval_delay_days:4,pending_objections:1,active_legal_disputes:0,ownership_disputes:0,court_stay_cases:0,rr_pending_cases:4,rr_completion_pct:94,schedule_variance_days:-12,milestones_overdue:0,pending_stakeholder_actions:2,avg_stakeholder_response_days:5.2,stakeholder_responsiveness_score:8.9,historical_avg_delay_days:14}},medium:{id:"preset-medium",name:"Western Freight Corridor",subtitle:"Baseline Model • FY26-Q1",tag:"MEDIUM RISK",values:{project_type:"Highway",land_type:"Agricultural",priority:"Normal",current_stage:"Notification",complexity_score:47.7,total_parcels:233,affected_families:113,land_area_hectares:132.47,planned_duration_days:607,days_since_notification:30,days_elapsed:30,days_in_current_stage:30,planned_stage_duration_days:26,acquisition_progress_pct:6.01,acquisition_velocity_pct_per_30d:6.13,parcels_pending:219,parcels_acquired:14,possession_pending_parcels:218,possession_progress_pct:6.47,documents_required:241,documents_pending:232,documents_verified:9,documentation_completion_pct:3.73,compensation_pending_cases:105,compensation_pending_amount:10.95,compensation_completion_pct:6.2,avg_compensation_delay_days:52.68,approvals_pending:5,overdue_approvals:2,avg_approval_delay_days:41.04,pending_objections:0,active_legal_disputes:0,ownership_disputes:0,court_stay_cases:0,rr_pending_cases:47,rr_completion_pct:4.08,schedule_variance_days:-7.19,milestones_overdue:1,pending_stakeholder_actions:7,avg_stakeholder_response_days:28.59,stakeholder_responsiveness_score:5.14,historical_avg_delay_days:100.8}},high:{id:"preset-high",name:"Docs Backlog Ph. 1",subtitle:"High Bottleneck • Stagnation Watchlist",tag:"HIGH RISK",values:{project_type:"Railway",land_type:"Commercial",priority:"Critical",current_stage:"Survey",complexity_score:68.5,total_parcels:1120,affected_families:420,land_area_hectares:210.5,planned_duration_days:900,days_since_notification:180,days_elapsed:180,days_in_current_stage:90,planned_stage_duration_days:60,acquisition_progress_pct:35,acquisition_velocity_pct_per_30d:2.5,parcels_pending:728,parcels_acquired:392,possession_pending_parcels:610,possession_progress_pct:28,documents_required:1120,documents_pending:580,documents_verified:540,documentation_completion_pct:48.2,compensation_pending_cases:240,compensation_pending_amount:42.6,compensation_completion_pct:38.5,avg_compensation_delay_days:72,approvals_pending:6,overdue_approvals:3,avg_approval_delay_days:65,pending_objections:18,active_legal_disputes:5,ownership_disputes:4,court_stay_cases:1,rr_pending_cases:85,rr_completion_pct:32,schedule_variance_days:54,milestones_overdue:3,pending_stakeholder_actions:9,avg_stakeholder_response_days:38,stakeholder_responsiveness_score:3.8,historical_avg_delay_days:95}},critical:{id:"preset-critical",name:"Court Injunction HC",subtitle:"Critical Hold • High Court Stay Active",tag:"CRITICAL RISK",values:{project_type:"Metro",land_type:"Industrial",priority:"Critical",current_stage:"Compensation",complexity_score:84,total_parcels:850,affected_families:610,land_area_hectares:184.2,planned_duration_days:1200,days_since_notification:360,days_elapsed:360,days_in_current_stage:180,planned_stage_duration_days:90,acquisition_progress_pct:22,acquisition_velocity_pct_per_30d:.8,parcels_pending:663,parcels_acquired:187,possession_pending_parcels:620,possession_progress_pct:18,documents_required:850,documents_pending:640,documents_verified:210,documentation_completion_pct:24.7,compensation_pending_cases:380,compensation_pending_amount:85.4,compensation_completion_pct:18,avg_compensation_delay_days:118,approvals_pending:9,overdue_approvals:6,avg_approval_delay_days:98,pending_objections:42,active_legal_disputes:14,ownership_disputes:8,court_stay_cases:4,rr_pending_cases:140,rr_completion_pct:14,schedule_variance_days:145,milestones_overdue:6,pending_stakeholder_actions:14,avg_stakeholder_response_days:52,stakeholder_responsiveness_score:2.1,historical_avg_delay_days:135}}},A=[{id:"BF-NH-2024-09",name:"Delhi-Amritsar Expressway (Pkg 4)",type:"Highway",sector:"National Highway",district:"Ludhiana",state:"Punjab",stage:"Sec 19 Declaration",progressPct:42,delayProbability:84.6,riskLevel:"CRITICAL",badgeClass:"bg-error-container text-on-error-container",presetKey:"critical"},{id:"BF-RL-2023-14",name:"Western Dedicated Freight Corridor",type:"Railway",sector:"Freight Rail Corridor",district:"Vadodara",state:"Gujarat",stage:"Compensation Award",progressPct:68,delayProbability:71.2,riskLevel:"HIGH",badgeClass:"bg-secondary-fixed text-on-secondary-fixed-variant",presetKey:"high"},{id:"BF-EN-2024-03",name:"Bhadla Solar Ultra Park Ext",type:"Power",sector:"Renewable Energy Grid",district:"Jodhpur",state:"Rajasthan",stage:"Joint Survey 3A",progressPct:31,delayProbability:58.4,riskLevel:"MEDIUM",badgeClass:"bg-amber-100 text-amber-900 border border-amber-300",presetKey:"medium"},{id:"BF-NH-2024-22",name:"NH-66 Coastal Highway Expansion",type:"Highway",sector:"National Highway",district:"Udupi",state:"Karnataka",stage:"Notification",progressPct:54,delayProbability:42.3,riskLevel:"MEDIUM",badgeClass:"bg-amber-100 text-amber-900 border border-amber-300",presetKey:"medium"},{id:"BF-MT-2024-05",name:"Pune Metro Line 3 Corridor",type:"Metro",sector:"Urban Mass Transit",district:"Pune",state:"Maharashtra",stage:"Rehabilitation",progressPct:79,delayProbability:34.8,riskLevel:"LOW",badgeClass:"bg-emerald-100 text-emerald-900 border border-emerald-300",presetKey:"low"},{id:"BF-IN-2024-18",name:"Dholera Special Investment Region Ph 1",type:"Industrial",sector:"Industrial Node / SEZ",district:"Ahmedabad",state:"Gujarat",stage:"Valuation",progressPct:62,delayProbability:46.1,riskLevel:"MEDIUM",badgeClass:"bg-amber-100 text-amber-900 border border-amber-300",presetKey:"medium"}];function Q(t){return typeof t!="number"||isNaN(t)?0:t>1?t/100:Math.max(0,t)}function g(t){const e=Q(t);return e>=.8?"CRITICAL":e>=.6?"HIGH":e>=.4?"MEDIUM":"LOW"}function Z(t){switch(typeof t=="string"?t.toUpperCase():g(t)){case"CRITICAL":return"Critical predicted delay risk";case"HIGH":return"High predicted delay risk";case"MEDIUM":return"Moderate predicted delay risk";case"LOW":default:return"Low predicted delay risk"}}function Y(t){switch(typeof t=="string"?t.toUpperCase():g(t)){case"CRITICAL":return"Critical predicted delay risk based on the current project snapshot.";case"HIGH":return"High predicted delay risk based on the current project snapshot.";case"MEDIUM":return"Moderate predicted delay risk based on the current project snapshot.";case"LOW":default:return"Low predicted delay risk based on the current project snapshot."}}function ee(t){switch(typeof t=="string"?t.toUpperCase():g(t)){case"CRITICAL":return"Risk Level: CRITICAL (Threshold ≥ 80%)";case"HIGH":return"Risk Level: HIGH (Threshold: 60% – 79.9%)";case"MEDIUM":return"Risk Level: MEDIUM (Threshold: 40% – 59.9%)";case"LOW":default:return"Risk Level: LOW (Threshold < 40%)"}}function E(t){switch(typeof t=="string"?t.toUpperCase():g(t)){case"CRITICAL":return"bg-red-100 text-red-900 border-red-300 dark:bg-red-950/60 dark:text-red-300 dark:border-red-800";case"HIGH":return"bg-orange-100 text-orange-900 border-orange-300 dark:bg-orange-950/60 dark:text-orange-300 dark:border-orange-800";case"MEDIUM":return"bg-amber-100 text-amber-900 border-amber-300 dark:bg-amber-950/60 dark:text-amber-300 dark:border-amber-800";case"LOW":default:return"bg-emerald-100 text-emerald-900 border-emerald-300 dark:bg-emerald-950/60 dark:text-emerald-300 dark:border-emerald-800"}}function M(t){switch(typeof t=="string"?t.toUpperCase():g(t)){case"CRITICAL":return"text-red-600 dark:text-red-400";case"HIGH":return"text-orange-600 dark:text-orange-400";case"MEDIUM":return"text-amber-600 dark:text-amber-400";case"LOW":default:return"text-emerald-600 dark:text-emerald-400"}}function te(t){switch(typeof t=="string"?t.toUpperCase():g(t)){case"CRITICAL":return"text-red-600 dark:text-red-500";case"HIGH":return"text-orange-500 dark:text-orange-400";case"MEDIUM":return"text-amber-500 dark:text-amber-400";case"LOW":default:return"text-emerald-500 dark:text-emerald-400"}}function ae(t,e,a){t.innerHTML=`
  ...
  `;const s=t.querySelector("#projectSearchInput"),n=t.querySelector("#projectsTableBody");s&&n&&s.addEventListener("input",r=>{const d=r.target.value.toLowerCase().trim(),p=A.filter(u=>u.id.toLowerCase().includes(d)||u.name.toLowerCase().includes(d)||u.district.toLowerCase().includes(d)||u.state.toLowerCase().includes(d));n.innerHTML=U(p),G(t,e,a)});const o=t.querySelector("#openAssessmentCtaBtn"),i=t.querySelector("#jumpToAssessmentBtn");o&&e&&o.addEventListener("click",()=>e("medium")),i&&e&&i.addEventListener("click",()=>e("high")),G(t,e,a)}function U(t){return t.length===0?'<tr><td colspan="7" class="text-center py-4 text-on-surface-variant">No matching projects found.</td></tr>':t.map(e=>`
    <tr class="hover:bg-surface-container-low/70 transition-colors group">
      ...
      <td class="py-space-sm px-space-sm font-tabular-data font-bold ${M(e.riskLevel||g(e.delayProbability))}">
        ${e.delayProbability}%
      </td>
      <td class="py-space-sm px-space-sm">
        <span class="px-2 py-0.5 rounded-full ${E(e.riskLevel||g(e.delayProbability))} font-label-sm text-label-sm font-bold inline-flex items-center gap-1 border">
  ...
  `).join("")}function G(t,e,a){t.querySelectorAll(".assess-project-btn").forEach(s=>{s.addEventListener("click",()=>{const n=s.getAttribute("data-preset")||"medium";e&&e(n)})}),t.querySelectorAll(".audit-project-btn").forEach(s=>{s.addEventListener("click",()=>{const n=s.getAttribute("data-id");a&&a(n)})})}const J="http://127.0.0.1:8000";class I extends Error{constructor(e,a=null,s=null){super(e),this.name="ApiError",this.status=a,this.details=s}}async function V(t,e={}){const a=`${J}${t}`,s=new AbortController,n=setTimeout(()=>s.abort(),e.timeout||15e3),o={"Content-Type":"application/json",Accept:"application/json"};try{const i=await fetch(a,{...e,headers:{...o,...e.headers||{}},signal:s.signal});clearTimeout(n);const r=i.headers.get("content-type")||"";let d=null;if(r.includes("application/json")?d=await i.json():d=await i.text(),!i.ok){const p=d&&typeof d=="object"&&d.detail?d.detail:`Request failed with status ${i.status}`;throw new I(p,i.status,d)}return d}catch(i){throw clearTimeout(n),i instanceof I?i:i.name==="AbortError"?new I("Request timed out while contacting Bhoomi Sakha prediction engine.",408):(console.debug(`[ApiClient] Network request failed for ${t}:`,i),new I("Prediction service is temporarily unavailable. Please try again.",0,i))}}const H={baseUrl:J,get(t,e={}){return V(t,{...e,method:"GET"})},post(t,e,a={}){return V(t,{...a,method:"POST",body:JSON.stringify(e)})}},O={async checkHealth(){try{const t=await H.get("/health",{timeout:4e3});return{online:t.status==="healthy",modelLoaded:!!t.model_loaded,featureCount:t.features||76,raw:t}}catch(t){return{online:!1,modelLoaded:!1,featureCount:0,error:t.message}}},async getMetadata(){return H.get("/meta")},async predictRisk(t){return H.post("/predict",t)}};let j={activePreset:"medium",lastPrediction:null,isLoading:!1};function se(t,e="medium"){j.activePreset=e;const a=R[e]||R.medium;t.innerHTML=`
    <div class="flex flex-col w-full">
  ...
  `,ne(t,a)}function ne(t,e){N(e.values),C(),t.querySelectorAll(".preset-pill").forEach(c=>{c.addEventListener("click",()=>{const b=c.getAttribute("data-preset");t.querySelectorAll(".preset-pill").forEach(f=>{f.classList.remove("bg-surface-container-high","ring-1","ring-secondary"),f.classList.add("bg-surface-container-low")}),c.classList.remove("bg-surface-container-low"),c.classList.add("bg-surface-container-high","ring-1","ring-secondary");const l=R[b];l&&(j.activePreset=b,N(l.values),C(),S(t))})});const a=t.querySelector("#field_docsPending"),s=t.querySelector("#field_docsReq");a&&a.addEventListener("input",C),s&&s.addEventListener("input",C);const n=t.querySelector("#runPredictionBtn");n&&n.addEventListener("click",()=>S(t));const o=t.querySelector("#resetScenarioBtn"),i=t.querySelector("#resetFormBtn"),r=()=>{const c=R[j.activePreset]||R.medium;N(c.values),C(),S(t)};o&&o.addEventListener("click",r),i&&i.addEventListener("click",r);const d=t.querySelector("#transparencyAccordionBtn"),p=t.querySelector("#transparencyContent"),u=t.querySelector("#accordionChevron");d&&p&&d.addEventListener("click",()=>{p.classList.contains("hidden")?(p.classList.remove("hidden"),u.style.transform="rotate(180deg)"):(p.classList.add("hidden"),u.style.transform="rotate(0deg)")}),S(t)}function C(){var o,i;const t=parseFloat((o=document.getElementById("field_docsReq"))==null?void 0:o.value)||1,e=parseFloat((i=document.getElementById("field_docsPending"))==null?void 0:i.value)||0,a=Math.max(0,Math.min(100,(t-e)/t*100)).toFixed(1),s=document.getElementById("label_docCompletion"),n=document.getElementById("bar_docCompletion");s&&(s.textContent=`${a}%`),n&&(n.style.width=`${a}%`)}function N(t){if(!t)return;const e=(a,s)=>{const n=document.getElementById(a);n&&s!==void 0&&(n.value=s)};e("field_projectType",t.project_type||"Highway"),e("field_landType",t.land_type||"Agricultural"),e("field_priority",t.priority||"Normal"),e("field_complexity",t.complexity_score??47.7),e("field_totalParcels",t.total_parcels??233),e("field_affectedFamilies",t.affected_families??113),e("field_landArea",t.land_area_hectares??132.5),e("field_plannedDuration",t.planned_duration_days??607),e("field_acqProgress",t.acquisition_progress_pct??6),e("field_velocity",t.acquisition_velocity_pct_per_30d??6.13),e("field_parcelsPending",t.parcels_pending??219),e("field_possessionPending",t.possession_pending_parcels??218),e("field_docsReq",t.documents_required??241),e("field_docsPending",t.documents_pending??232),e("field_compCases",t.compensation_pending_cases??105),e("field_compAmount",t.compensation_pending_amount??10.95),e("field_compDisbursed",t.compensation_completion_pct??6.2),e("field_apprPending",t.approvals_pending??5),e("field_apprOverdue",t.overdue_approvals??2),e("field_apprDelay",t.avg_approval_delay_days??41),e("field_pendingObj",t.pending_objections??0),e("field_activeDisputes",t.active_legal_disputes??0),e("field_ownerDisputes",t.ownership_disputes??0),e("field_courtStays",t.court_stay_cases??0),e("field_rrPending",t.rr_pending_cases??47),e("field_rrCompletion",t.rr_completion_pct??4.08),e("field_schedVariance",t.schedule_variance_days??-7.19),e("field_milestonesOverdue",t.milestones_overdue??1),e("field_shActions",t.pending_stakeholder_actions??7),e("field_shResponse",t.avg_stakeholder_response_days??28.59),e("field_shScore",t.stakeholder_responsiveness_score??5.14),e("field_histDelay",t.historical_avg_delay_days??100.8)}function ie(){var l;const t=(f,v=0)=>{var w;const x=parseFloat((w=document.getElementById(f))==null?void 0:w.value);return isNaN(x)?v:Math.max(0,x)},e=(f,v=0)=>{var w;const x=parseInt((w=document.getElementById(f))==null?void 0:w.value,10);return isNaN(x)?v:Math.max(0,x)},a=(f,v="")=>{var x;return((x=document.getElementById(f))==null?void 0:x.value)||v},s=e("field_totalParcels",200),n=e("field_parcelsPending",50),o=Math.max(0,s-n),i=e("field_docsReq",200),r=e("field_docsPending",50),d=Math.max(0,i-r),p=i>0?Math.min(100,Math.max(0,d/i*100)):0,u=e("field_compCases",10),c=t("field_compAmount",10),b=Math.min(100,t("field_compDisbursed",50));return{project_type:a("field_projectType","Highway"),land_type:a("field_landType","Mixed"),priority:a("field_priority","Normal"),current_stage:"Survey",complexity_score:t("field_complexity",40),total_parcels:s,parcels_pending:n,parcels_acquired:o,affected_families:t("field_affectedFamilies",50),land_area_hectares:t("field_landArea",100),planned_duration_days:e("field_plannedDuration",600),days_since_notification:30,days_elapsed:30,days_in_current_stage:30,planned_stage_duration_days:30,schedule_variance_days:parseFloat((l=document.getElementById("field_schedVariance"))==null?void 0:l.value)||0,milestones_due:2,milestones_completed:1,milestones_overdue:e("field_milestonesOverdue",0),acquisition_progress_pct:Math.min(100,t("field_acqProgress",50)),acquisition_velocity_pct_per_30d:t("field_velocity",5),possession_progress_pct:Math.min(100,(1-e("field_possessionPending",50)/Math.max(1,s))*100),possession_pending_parcels:e("field_possessionPending",50),compensation_total_amount:c*1.5,compensation_assessed_amount:c*1.2,compensation_disbursed_amount:c*.5,compensation_pending_amount:c,compensation_completion_pct:b,compensation_pending_cases:u,avg_compensation_delay_days:u*.5,documents_required:i,documents_verified:d,documents_pending:r,documentation_completion_pct:p,approvals_required:10,approvals_completed:5,approvals_pending:e("field_apprPending",2),approval_completion_pct:50,avg_approval_delay_days:t("field_apprDelay",10),overdue_approvals:e("field_apprOverdue",0),active_legal_disputes:e("field_activeDisputes",0),resolved_legal_disputes:0,ownership_disputes:e("field_ownerDisputes",0),court_stay_cases:e("field_courtStays",0),pending_objections:e("field_pendingObj",0),families_requiring_rr:e("field_rrPending",0)+10,families_rr_completed:10,rr_completion_pct:Math.min(100,t("field_rrCompletion",50)),rr_pending_cases:e("field_rrPending",0),pending_stakeholder_actions:e("field_shActions",0),avg_stakeholder_response_days:t("field_shResponse",10),stakeholder_responsiveness_score:t("field_shScore",5),interdepartmental_pending_actions:2,historical_avg_delay_days:t("field_histDelay",50)}}async function S(t){const e=t.querySelector("#loadingOverlay"),a=t.querySelector("#runPredictionBtn");e&&e.classList.remove("hidden"),a&&(a.disabled=!0,a.classList.add("opacity-70","cursor-not-allowed"));try{const s=ie(),n=await O.predictRisk(s);j.lastPrediction=n,oe(t,n)}catch(s){console.error("Prediction failed:",s),re(t,s.message)}finally{e&&e.classList.add("hidden"),a&&(a.disabled=!1,a.classList.remove("opacity-70","cursor-not-allowed"))}}function oe(t,e){const a=e.delay_probability_pct!==void 0?e.delay_probability_pct:e.delay_probability!==void 0?e.delay_probability*100:0,s=typeof a=="number"&&!isNaN(a)?a:0,n=g(s),o=Z(n),i=Y(n),r=ee(n),d=t.querySelector("#probabilityValue"),p=t.querySelector("#probabilityCircle"),u=t.querySelector("#decisionOutcome"),c=t.querySelector("#riskBadge"),b=t.querySelector("#riskSummaryText"),l=t.querySelector("#riskThresholdNote");d&&(d.textContent=`${s.toFixed(2)}%`),u&&(u.textContent=o,u.className=`mt-1 font-label-sm text-[11px] font-semibold ${M(n)}`),b&&(b.textContent=i),l&&(l.textContent=r);const f=301.59,v=f-f*(Math.min(100,Math.max(0,s))/100);p&&(p.style.strokeDashoffset=v,p.className=`transition-all duration-700 ease-out ${te(n)}`),c&&(c.textContent=`${n} RISK`,c.className=`px-space-sm py-1 rounded font-label-sm text-label-sm font-bold uppercase tracking-wider border ${E(n)}`);const x=t.querySelector("#riskIncreasingContainer");if(x){const y=e.risk_drivers||[];if(y.length===0)x.innerHTML=`
      ...
      `;else{const k=Math.max(...y.map(m=>Math.abs(m.contribution)),.1);x.innerHTML=y.map(m=>{const P=Math.min(100,Math.max(15,Math.abs(m.contribution)/k*100)),F=m.contribution>.4?"bg-error":"bg-secondary-container";return`
          <div class="flex flex-col gap-1 border-b border-surface-container-high/40 pb-2 last:border-none">
            ...
            <div class="w-full bg-surface-container-high rounded-full h-2 overflow-hidden">
              <div class="${F} h-full rounded-full transition-all duration-700" style="width: ${P.toFixed(0)}%;"></div>
            </div>
        ...
        `}).join("")}}const w=t.querySelector("#riskReducingContainer");if(w){const y=e.risk_reducing_factors||[];if(y.length===0)w.innerHTML=`
        <div class="text-on-surface-variant font-body-sm text-sm italic py-2">
          No significant risk-reducing factors detected.
        </div>
      `;else{const k=Math.max(...y.map(m=>Math.abs(m.contribution)),.1);w.innerHTML=y.map(m=>{const P=Math.min(100,Math.max(15,Math.abs(m.contribution)/k*100));return`
          <div class="flex flex-col gap-1 border-b border-surface-container-high/40 pb-2 last:border-none">
            <div class="flex items-center justify-between font-label-sm text-label-sm">
        ...
        `}).join("")}}const D=t.querySelector("#directivesContainer");if(D){const y=e.risk_drivers||[];y.length>0?D.innerHTML=y.slice(0,2).map((k,m)=>`
          <div class="p-space-sm bg-surface-container-low rounded-lg flex items-start gap-space-sm border border-outline-variant/30">
            ...
            <div class="flex flex-col">
              <span class="font-label-sm text-label-sm font-bold text-on-surface">${k.factor} Resolution</span>
              <p class="font-body-sm text-[12px] text-on-surface-variant mt-0.5">${k.recommendation}</p>
            </div>
          </div>
        `).join(""):D.innerHTML=`
      ...
      `}}function re(t,e){const a=t.querySelector("#riskIncreasingContainer"),s=e&&!e.includes("uvicorn")?e:"Prediction service is temporarily unavailable. Please try again.";if(a){a.innerHTML=`
    ...
    `;const n=a.querySelector("#retryPredictionBtn");n&&n.addEventListener("click",()=>S(t))}}function le(t,e,a){t.innerHTML=`
  ...
  `;const s=t.querySelector("#directoryTableBody"),n=t.querySelector("#directorySearchInput"),o=t.querySelector("#filterSector"),i=t.querySelector("#filterRisk"),r=()=>{const p=((n==null?void 0:n.value)||"").toLowerCase().trim(),u=(o==null?void 0:o.value)||"all",c=(i==null?void 0:i.value)||"all",b=A.filter(l=>{const f=l.id.toLowerCase().includes(p)||l.name.toLowerCase().includes(p)||l.district.toLowerCase().includes(p)||l.state.toLowerCase().includes(p),v=u==="all"||l.type===u,x=c==="all"||l.riskLevel===c;return f&&v&&x});if(b.length===0){s.innerHTML='<tr><td colspan="8" class="text-center py-6 text-on-surface-variant">No matching records found in national database.</td></tr>';return}s.innerHTML=b.map(l=>`
      <tr class="hover:bg-surface-container-low/70 transition-colors">
        ...
        <td class="py-space-md px-space-md font-tabular-data font-bold ${M(l.riskLevel||g(l.delayProbability))}">${l.delayProbability}%</td>
        <td class="py-space-md px-space-md">
          <span class="px-2 py-0.5 rounded-full ${E(l.riskLevel||g(l.delayProbability))} font-label-sm text-xs font-bold border">${l.riskLevel||g(l.delayProbability)}</span>
        </td>
    ...
    `).join(""),s.querySelectorAll(".dir-assess-btn").forEach(l=>{l.addEventListener("click",()=>{const f=l.getAttribute("data-preset");e&&e(f)})}),s.querySelectorAll(".dir-audit-btn").forEach(l=>{l.addEventListener("click",()=>{const f=l.getAttribute("data-id");a&&a(f)})})};n&&n.addEventListener("input",r),o&&o.addEventListener("change",r),i&&i.addEventListener("change",r);const d=t.querySelector("#newAssessmentBtn");d&&e&&d.addEventListener("click",()=>e("medium")),r()}function de(t,e="BF-NH-2024-09",a){const s=A.find(r=>r.id===e)||A[0],n=g(s.delayProbability);t.innerHTML=`
    <div class="flex flex-col w-full">
        ...
        <div class="w-full bg-surface-container-lowest rounded-xl shadow-sm overflow-hidden grid grid-cols-1 lg:grid-cols-12 border border-outline-variant/30">
          ...
          <div class="lg:col-span-4 ${n==="CRITICAL"?"bg-error-container/40":n==="HIGH"?"bg-orange-50 dark:bg-orange-950/40":n==="MEDIUM"?"bg-amber-50 dark:bg-amber-950/40":"bg-emerald-50 dark:bg-emerald-950/40"} p-space-xl flex flex-col justify-between relative overflow-hidden">
            <div class="flex flex-col gap-space-md relative z-10">
              <div class="flex items-center justify-between">
                <span class="px-space-xs py-1 rounded ${E(n)} font-label-sm text-label-sm font-bold uppercase tracking-wider flex items-center gap-1.5 shadow-sm border">
              ...
              <div class="flex flex-col pt-space-xs">
                ...
                <div class="flex items-baseline gap-space-xs">
                  <span class="font-headline-xl text-headline-xl font-tabular-data ${M(n)} font-extrabold tracking-tight">${s.delayProbability}%</span>
  ...
  `;const o=t.querySelector("#detailRerunBtn");o&&a&&o.addEventListener("click",()=>a(s.presetKey||"medium"));const i=t.querySelector("#backToProjectsBreadcrumb");i&&i.addEventListener("click",()=>{window.location.hash="#/projects"})}const W="bhoomi_notifications_read",q=[{id:"notif-crit-1",category:"Risk Alert",severity:"critical",title:"Critical delay risk detected in current assessment",summary:"Delhi-Amritsar Expressway (Pkg 4) evaluated with 84.6% delay probability requiring urgent Section 19 intervention.",timestamp:"15 mins ago",actionRoute:"#/assessment?preset=critical",actionLabel:"Inspect Assessment"},{id:"notif-engine-2",category:"Engine",severity:"info",title:"Backend prediction engine connected",summary:"FastAPI service connected with 76 engineered cadastral features ready for live XGBoost inference.",timestamp:"1 hour ago",actionRoute:"#/dashboard",actionLabel:"View Dashboard"},{id:"notif-atten-3",category:"Officer Attention",severity:"high",title:"Assessment contains factors requiring officer attention",summary:"18 high-bottleneck parcel cases in Western Freight Corridor flagged for documentation backlog review.",timestamp:"3 hours ago",actionRoute:"#/assessment?preset=high",actionLabel:"Review Factors"},{id:"notif-stat-4",category:"System",severity:"info",title:"Risk assessment pipeline initialized",summary:"National Cadastral Matrix synchronized with 142 monitored infrastructure corridors.",timestamp:"Today, 09:30 AM",actionRoute:"#/projects",actionLabel:"Projects Directory"}];class ce{constructor(){this.listeners=[]}getReadIds(){try{const e=localStorage.getItem(W);return e?JSON.parse(e):[]}catch{return[]}}saveReadIds(e){try{localStorage.setItem(W,JSON.stringify(e)),this.notifyListeners()}catch(a){console.error("Failed to save read notifications:",a)}}getAll(){const e=new Set(this.getReadIds());return q.map(a=>({...a,isRead:e.has(a.id)}))}getUnreadCount(){const e=new Set(this.getReadIds());return q.filter(a=>!e.has(a.id)).length}markAsRead(e){const a=new Set(this.getReadIds());a.add(e),this.saveReadIds(Array.from(a))}markAsUnread(e){const a=new Set(this.getReadIds());a.delete(e),this.saveReadIds(Array.from(a))}markAllAsRead(){const e=q.map(a=>a.id);this.saveReadIds(e)}resetAll(){this.saveReadIds([])}subscribe(e){return this.listeners.push(e),()=>{this.listeners=this.listeners.filter(a=>a!==e)}}notifyListeners(){const e=this.getUnreadCount();this.listeners.forEach(a=>a(e))}}const _=new ce;function pe(t,e){let a="all";function s(){const n=_.getAll(),o=_.getUnreadCount(),i=a==="unread"?n.filter(c=>!c.isRead):n;t.innerHTML=`
      <div class="px-margin-desktop py-space-xl flex flex-col gap-space-lg w-full max-w-5xl mx-auto">
        ...
        <div class="flex flex-col gap-3" id="notificationsList">
          ...
          `:i.map(c=>{const b=c.severity==="critical"?"border-l-4 border-l-red-500 bg-red-50/20 dark:bg-red-950/20":c.severity==="high"?"border-l-4 border-l-orange-500 bg-orange-50/20 dark:bg-orange-950/20":"border-l-4 border-l-sky-500 bg-sky-50/20 dark:bg-sky-950/20",l=c.isRead?"opacity-85 border border-outline-variant/20 bg-surface-container-lowest":"border border-outline-variant/50 shadow-sm";return`
              <div class="p-space-md rounded-xl ${b} ${l} bg-surface-container-lowest flex flex-col md:flex-row md:items-center justify-between gap-space-sm transition-all" data-id="${c.id}">
                <div class="flex items-start gap-space-sm">
                  ...
                  <div class="flex flex-col gap-1">
                    <div class="flex items-center gap-2 flex-wrap">
                      ...
                      <span class="font-body-sm text-xs text-on-surface-variant font-tabular-data">${c.timestamp}</span>
                      ${c.isRead?"":`
                        <span class="px-1.5 py-0.2 rounded text-[10px] bg-secondary-fixed text-on-secondary-fixed font-bold uppercase">New</span>
                      `}
                    </div>
                    <h3 class="font-headline-sm text-base text-on-surface font-semibold ${c.isRead?"":"font-bold"}">
                      ${c.title}
                    </h3>
                ...
                <div class="flex items-center gap-2 shrink-0 self-end md:self-center pl-6 md:pl-0">
                  <a class="px-3 py-1.5 rounded font-label-sm text-xs font-semibold bg-primary text-on-primary hover:bg-surface-tint transition-colors flex items-center gap-1" href="${c.actionRoute}">
                    <span>${c.actionLabel}</span>
                    <span class="material-symbols-outlined text-[14px]">arrow_forward</span>
                  </a>
                  <button class="toggle-read-btn p-1.5 rounded text-on-surface-variant hover:text-on-surface hover:bg-surface-container transition-colors" data-id="${c.id}" title="${c.isRead?"Mark as Unread":"Mark as Read"}" type="button">
                    <span class="material-symbols-outlined text-[18px]">
                      ${c.isRead?"mark_email_unread":"check_circle"}
                    </span>
                  </button>
                </div>
              </div>
    ...
    `,s.appendChild(n),requestAnimationFrame(()=>{n.classList.remove("translate-y-2","opacity-0")}),setTimeout(()=>{n.classList.add("opacity-0","translate-y-2"),setTimeout(()=>n.remove(),300)},4500)}}document.addEventListener("DOMContentLoaded",()=>{new ge().init()});
