(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const l of a)if(l.type==="childList")for(const o of l.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function n(a){const l={};return a.integrity&&(l.integrity=a.integrity),a.referrerPolicy&&(l.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?l.credentials="include":a.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function s(a){if(a.ep)return;a.ep=!0;const l=n(a);fetch(a.href,l)}})();const C={low:{id:"preset-low",name:"NH-44 Bypass Ph. 2",subtitle:"Low Delay • Clear Title",tag:"LOW RISK",values:{project_type:"Highway",land_type:"Agricultural",priority:"Normal",current_stage:"Notification",complexity_score:22.4,total_parcels:350,affected_families:48,land_area_hectares:65.2,planned_duration_days:420,days_since_notification:45,days_elapsed:45,days_in_current_stage:45,planned_stage_duration_days:60,acquisition_progress_pct:88.5,acquisition_velocity_pct_per_30d:14.8,parcels_pending:40,parcels_acquired:310,possession_pending_parcels:25,possession_progress_pct:92.8,documents_required:350,documents_pending:18,documents_verified:332,documentation_completion_pct:94.9,compensation_pending_cases:12,compensation_pending_amount:3.5,compensation_completion_pct:96.2,avg_compensation_delay_days:8,approvals_pending:1,overdue_approvals:0,avg_approval_delay_days:4,pending_objections:1,active_legal_disputes:0,ownership_disputes:0,court_stay_cases:0,rr_pending_cases:4,rr_completion_pct:94,schedule_variance_days:-12,milestones_overdue:0,pending_stakeholder_actions:2,avg_stakeholder_response_days:5.2,stakeholder_responsiveness_score:8.9,historical_avg_delay_days:14}},medium:{id:"preset-medium",name:"Western Freight Corridor",subtitle:"Baseline Model • FY26-Q1",tag:"MEDIUM RISK",values:{project_type:"Highway",land_type:"Agricultural",priority:"Normal",current_stage:"Notification",complexity_score:47.7,total_parcels:233,affected_families:113,land_area_hectares:132.47,planned_duration_days:607,days_since_notification:30,days_elapsed:30,days_in_current_stage:30,planned_stage_duration_days:26,acquisition_progress_pct:6.01,acquisition_velocity_pct_per_30d:6.13,parcels_pending:219,parcels_acquired:14,possession_pending_parcels:218,possession_progress_pct:6.47,documents_required:241,documents_pending:232,documents_verified:9,documentation_completion_pct:3.73,compensation_pending_cases:105,compensation_pending_amount:10.95,compensation_completion_pct:6.2,avg_compensation_delay_days:52.68,approvals_pending:5,overdue_approvals:2,avg_approval_delay_days:41.04,pending_objections:0,active_legal_disputes:0,ownership_disputes:0,court_stay_cases:0,rr_pending_cases:47,rr_completion_pct:4.08,schedule_variance_days:-7.19,milestones_overdue:1,pending_stakeholder_actions:7,avg_stakeholder_response_days:28.59,stakeholder_responsiveness_score:5.14,historical_avg_delay_days:100.8}},high:{id:"preset-high",name:"Docs Backlog Ph. 1",subtitle:"High Bottleneck • Stagnation Watchlist",tag:"HIGH RISK",values:{project_type:"Railway",land_type:"Commercial",priority:"Critical",current_stage:"Survey",complexity_score:68.5,total_parcels:1120,affected_families:420,land_area_hectares:210.5,planned_duration_days:900,days_since_notification:180,days_elapsed:180,days_in_current_stage:90,planned_stage_duration_days:60,acquisition_progress_pct:35,acquisition_velocity_pct_per_30d:2.5,parcels_pending:728,parcels_acquired:392,possession_pending_parcels:610,possession_progress_pct:28,documents_required:1120,documents_pending:580,documents_verified:540,documentation_completion_pct:48.2,compensation_pending_cases:240,compensation_pending_amount:42.6,compensation_completion_pct:38.5,avg_compensation_delay_days:72,approvals_pending:6,overdue_approvals:3,avg_approval_delay_days:65,pending_objections:18,active_legal_disputes:5,ownership_disputes:4,court_stay_cases:1,rr_pending_cases:85,rr_completion_pct:32,schedule_variance_days:54,milestones_overdue:3,pending_stakeholder_actions:9,avg_stakeholder_response_days:38,stakeholder_responsiveness_score:3.8,historical_avg_delay_days:95}},critical:{id:"preset-critical",name:"Court Injunction HC",subtitle:"Critical Hold • High Court Stay Active",tag:"CRITICAL RISK",values:{project_type:"Metro",land_type:"Industrial",priority:"Critical",current_stage:"Compensation",complexity_score:84,total_parcels:850,affected_families:610,land_area_hectares:184.2,planned_duration_days:1200,days_since_notification:360,days_elapsed:360,days_in_current_stage:180,planned_stage_duration_days:90,acquisition_progress_pct:22,acquisition_velocity_pct_per_30d:.8,parcels_pending:663,parcels_acquired:187,possession_pending_parcels:620,possession_progress_pct:18,documents_required:850,documents_pending:640,documents_verified:210,documentation_completion_pct:24.7,compensation_pending_cases:380,compensation_pending_amount:85.4,compensation_completion_pct:18,avg_compensation_delay_days:118,approvals_pending:9,overdue_approvals:6,avg_approval_delay_days:98,pending_objections:42,active_legal_disputes:14,ownership_disputes:8,court_stay_cases:4,rr_pending_cases:140,rr_completion_pct:14,schedule_variance_days:145,milestones_overdue:6,pending_stakeholder_actions:14,avg_stakeholder_response_days:52,stakeholder_responsiveness_score:2.1,historical_avg_delay_days:135}}},P=[{id:"BF-NH-2024-09",name:"Delhi-Amritsar Expressway (Pkg 4)",type:"Highway",sector:"National Highway",district:"Ludhiana",state:"Punjab",stage:"Sec 19 Declaration",progressPct:42,delayProbability:84.6,riskLevel:"CRITICAL",badgeClass:"bg-error-container text-on-error-container",presetKey:"critical"},{id:"BF-RL-2023-14",name:"Western Dedicated Freight Corridor",type:"Railway",sector:"Freight Rail Corridor",district:"Vadodara",state:"Gujarat",stage:"Compensation Award",progressPct:68,delayProbability:71.2,riskLevel:"HIGH",badgeClass:"bg-secondary-fixed text-on-secondary-fixed-variant",presetKey:"high"},{id:"BF-EN-2024-03",name:"Bhadla Solar Ultra Park Ext",type:"Power",sector:"Renewable Energy Grid",district:"Jodhpur",state:"Rajasthan",stage:"Joint Survey 3A",progressPct:31,delayProbability:58.4,riskLevel:"MEDIUM",badgeClass:"bg-amber-100 text-amber-900 border border-amber-300",presetKey:"medium"},{id:"BF-NH-2024-22",name:"NH-66 Coastal Highway Expansion",type:"Highway",sector:"National Highway",district:"Udupi",state:"Karnataka",stage:"Notification",progressPct:54,delayProbability:42.3,riskLevel:"MEDIUM",badgeClass:"bg-amber-100 text-amber-900 border border-amber-300",presetKey:"medium"},{id:"BF-MT-2024-05",name:"Pune Metro Line 3 Corridor",type:"Metro",sector:"Urban Mass Transit",district:"Pune",state:"Maharashtra",stage:"Rehabilitation",progressPct:79,delayProbability:34.8,riskLevel:"LOW",badgeClass:"bg-emerald-100 text-emerald-900 border border-emerald-300",presetKey:"low"},{id:"BF-IN-2024-18",name:"Dholera Special Investment Region Ph 1",type:"Industrial",sector:"Industrial Node / SEZ",district:"Ahmedabad",state:"Gujarat",stage:"Valuation",progressPct:62,delayProbability:46.1,riskLevel:"MEDIUM",badgeClass:"bg-amber-100 text-amber-900 border border-amber-300",presetKey:"medium"}];function O(e){return typeof e!="number"||isNaN(e)?0:e>1?e/100:Math.max(0,e)}function x(e){const t=O(e);return t>=.8?"CRITICAL":t>=.6?"HIGH":t>=.4?"MEDIUM":"LOW"}function F(e){switch(typeof e=="string"?e.toUpperCase():x(e)){case"CRITICAL":return"Critical predicted delay risk";case"HIGH":return"High predicted delay risk";case"MEDIUM":return"Moderate predicted delay risk";case"LOW":default:return"Low predicted delay risk"}}function $(e){switch(typeof e=="string"?e.toUpperCase():x(e)){case"CRITICAL":return"Critical predicted delay risk based on the current project snapshot.";case"HIGH":return"High predicted delay risk based on the current project snapshot.";case"MEDIUM":return"Moderate predicted delay risk based on the current project snapshot.";case"LOW":default:return"Low predicted delay risk based on the current project snapshot."}}function G(e){switch(typeof e=="string"?e.toUpperCase():x(e)){case"CRITICAL":return"Risk Level: CRITICAL (Threshold ≥ 80%)";case"HIGH":return"Risk Level: HIGH (Threshold: 60% – 79.9%)";case"MEDIUM":return"Risk Level: MEDIUM (Threshold: 40% – 59.9%)";case"LOW":default:return"Risk Level: LOW (Threshold < 40%)"}}function R(e){switch(typeof e=="string"?e.toUpperCase():x(e)){case"CRITICAL":return"bg-red-100 text-red-900 border-red-300 dark:bg-red-950/60 dark:text-red-300 dark:border-red-800";case"HIGH":return"bg-orange-100 text-orange-900 border-orange-300 dark:bg-orange-950/60 dark:text-orange-300 dark:border-orange-800";case"MEDIUM":return"bg-amber-100 text-amber-900 border-amber-300 dark:bg-amber-950/60 dark:text-amber-300 dark:border-amber-800";case"LOW":default:return"bg-emerald-100 text-emerald-900 border-emerald-300 dark:bg-emerald-950/60 dark:text-emerald-300 dark:border-emerald-800"}}function j(e){switch(typeof e=="string"?e.toUpperCase():x(e)){case"CRITICAL":return"text-red-600 dark:text-red-400";case"HIGH":return"text-orange-600 dark:text-orange-400";case"MEDIUM":return"text-amber-600 dark:text-amber-400";case"LOW":default:return"text-emerald-600 dark:text-emerald-400"}}function U(e){switch(typeof e=="string"?e.toUpperCase():x(e)){case"CRITICAL":return"text-red-600 dark:text-red-500";case"HIGH":return"text-orange-500 dark:text-orange-400";case"MEDIUM":return"text-amber-500 dark:text-amber-400";case"LOW":default:return"text-emerald-500 dark:text-emerald-400"}}function V(e,t,n){e.innerHTML=`
  ...
  `;const s=e.querySelector("#projectSearchInput"),a=e.querySelector("#projectsTableBody");s&&a&&s.addEventListener("input",i=>{const d=i.target.value.toLowerCase().trim(),c=P.filter(f=>f.id.toLowerCase().includes(d)||f.name.toLowerCase().includes(d)||f.district.toLowerCase().includes(d)||f.state.toLowerCase().includes(d));a.innerHTML=D(c),H(e,t,n)});const l=e.querySelector("#openAssessmentCtaBtn"),o=e.querySelector("#jumpToAssessmentBtn");l&&t&&l.addEventListener("click",()=>t("medium")),o&&t&&o.addEventListener("click",()=>t("high")),H(e,t,n)}function D(e){return e.length===0?'<tr><td colspan="7" class="text-center py-4 text-on-surface-variant">No matching projects found.</td></tr>':e.map(t=>`
    <tr class="hover:bg-surface-container-low/70 transition-colors group">
      ...
      <td class="py-space-sm px-space-sm font-tabular-data font-bold ${j(t.riskLevel||x(t.delayProbability))}">
        ${t.delayProbability}%
      </td>
      <td class="py-space-sm px-space-sm">
        <span class="px-2 py-0.5 rounded-full ${R(t.riskLevel||x(t.delayProbability))} font-label-sm text-label-sm font-bold inline-flex items-center gap-1 border">
          <span class="w-1.5 h-1.5 rounded-full bg-current"></span>
          ${t.riskLevel||x(t.delayProbability)}
        </span>
      </td>
  ...
  `).join("")}function H(e,t,n){e.querySelectorAll(".assess-project-btn").forEach(s=>{s.addEventListener("click",()=>{const a=s.getAttribute("data-preset")||"medium";t&&t(a)})}),e.querySelectorAll(".audit-project-btn").forEach(s=>{s.addEventListener("click",()=>{const a=s.getAttribute("data-id");n&&n(a)})})}const N="http://127.0.0.1:8000";class L extends Error{constructor(t,n=null,s=null){super(t),this.name="ApiError",this.status=n,this.details=s}}async function q(e,t={}){const n=`${N}${e}`,s=new AbortController,a=setTimeout(()=>s.abort(),t.timeout||15e3),l={"Content-Type":"application/json",Accept:"application/json"};try{const o=await fetch(n,{...t,headers:{...l,...t.headers||{}},signal:s.signal});clearTimeout(a);const i=o.headers.get("content-type")||"";let d=null;if(i.includes("application/json")?d=await o.json():d=await o.text(),!o.ok){const c=d&&typeof d=="object"&&d.detail?d.detail:`Request failed with status ${o.status}`;throw new L(c,o.status,d)}return d}catch(o){throw clearTimeout(a),o instanceof L?o:o.name==="AbortError"?new L("Request timed out while contacting Bhoomi Sakha prediction engine.",408):(console.debug(`[ApiClient] Network request failed for ${e}:`,o),new L("Prediction service is temporarily unavailable. Please try again.",0,o))}}const M={baseUrl:N,get(e,t={}){return q(e,{...t,method:"GET"})},post(e,t,n={}){return q(e,{...n,method:"POST",body:JSON.stringify(t)})}},T={async checkHealth(){try{const e=await M.get("/health",{timeout:4e3});return{online:e.status==="healthy",modelLoaded:!!e.model_loaded,featureCount:e.features||76,raw:e}}catch(e){return{online:!1,modelLoaded:!1,featureCount:0,error:e.message}}},async getMetadata(){return M.get("/meta")},async predictRisk(e){return M.post("/predict",e)}};let I={activePreset:"medium",lastPrediction:null,isLoading:!1};function W(e,t="medium"){I.activePreset=t;const n=C[t]||C.medium;e.innerHTML=`
    <div class="flex flex-col w-full">
  ...
  `,K(e,n)}function K(e,t){E(t.values),_(),e.querySelectorAll(".preset-pill").forEach(p=>{p.addEventListener("click",()=>{const v=p.getAttribute("data-preset");e.querySelectorAll(".preset-pill").forEach(m=>{m.classList.remove("bg-surface-container-high","ring-1","ring-secondary"),m.classList.add("bg-surface-container-low")}),p.classList.remove("bg-surface-container-low"),p.classList.add("bg-surface-container-high","ring-1","ring-secondary");const r=C[v];r&&(I.activePreset=v,E(r.values),_(),k(e))})});const n=e.querySelector("#field_docsPending"),s=e.querySelector("#field_docsReq");n&&n.addEventListener("input",_),s&&s.addEventListener("input",_);const a=e.querySelector("#runPredictionBtn");a&&a.addEventListener("click",()=>k(e));const l=e.querySelector("#resetScenarioBtn"),o=e.querySelector("#resetFormBtn"),i=()=>{const p=C[I.activePreset]||C.medium;E(p.values),_(),k(e)};l&&l.addEventListener("click",i),o&&o.addEventListener("click",i);const d=e.querySelector("#transparencyAccordionBtn"),c=e.querySelector("#transparencyContent"),f=e.querySelector("#accordionChevron");d&&c&&d.addEventListener("click",()=>{c.classList.contains("hidden")?(c.classList.remove("hidden"),f.style.transform="rotate(180deg)"):(c.classList.add("hidden"),f.style.transform="rotate(0deg)")}),k(e)}function _(){var l,o;const e=parseFloat((l=document.getElementById("field_docsReq"))==null?void 0:l.value)||1,t=parseFloat((o=document.getElementById("field_docsPending"))==null?void 0:o.value)||0,n=Math.max(0,Math.min(100,(e-t)/e*100)).toFixed(1),s=document.getElementById("label_docCompletion"),a=document.getElementById("bar_docCompletion");s&&(s.textContent=`${n}%`),a&&(a.style.width=`${n}%`)}function E(e){if(!e)return;const t=(n,s)=>{const a=document.getElementById(n);a&&s!==void 0&&(a.value=s)};t("field_projectType",e.project_type||"Highway"),t("field_landType",e.land_type||"Agricultural"),t("field_priority",e.priority||"Normal"),t("field_complexity",e.complexity_score??47.7),t("field_totalParcels",e.total_parcels??233),t("field_affectedFamilies",e.affected_families??113),t("field_landArea",e.land_area_hectares??132.5),t("field_plannedDuration",e.planned_duration_days??607),t("field_acqProgress",e.acquisition_progress_pct??6),t("field_velocity",e.acquisition_velocity_pct_per_30d??6.13),t("field_parcelsPending",e.parcels_pending??219),t("field_possessionPending",e.possession_pending_parcels??218),t("field_docsReq",e.documents_required??241),t("field_docsPending",e.documents_pending??232),t("field_compCases",e.compensation_pending_cases??105),t("field_compAmount",e.compensation_pending_amount??10.95),t("field_compDisbursed",e.compensation_completion_pct??6.2),t("field_apprPending",e.approvals_pending??5),t("field_apprOverdue",e.overdue_approvals??2),t("field_apprDelay",e.avg_approval_delay_days??41),t("field_pendingObj",e.pending_objections??0),t("field_activeDisputes",e.active_legal_disputes??0),t("field_ownerDisputes",e.ownership_disputes??0),t("field_courtStays",e.court_stay_cases??0),t("field_rrPending",e.rr_pending_cases??47),t("field_rrCompletion",e.rr_completion_pct??4.08),t("field_schedVariance",e.schedule_variance_days??-7.19),t("field_milestonesOverdue",e.milestones_overdue??1),t("field_shActions",e.pending_stakeholder_actions??7),t("field_shResponse",e.avg_stakeholder_response_days??28.59),t("field_shScore",e.stakeholder_responsiveness_score??5.14),t("field_histDelay",e.historical_avg_delay_days??100.8)}function z(){var r;const e=(m,y=0)=>{var h;const b=parseFloat((h=document.getElementById(m))==null?void 0:h.value);return isNaN(b)?y:Math.max(0,b)},t=(m,y=0)=>{var h;const b=parseInt((h=document.getElementById(m))==null?void 0:h.value,10);return isNaN(b)?y:Math.max(0,b)},n=(m,y="")=>{var b;return((b=document.getElementById(m))==null?void 0:b.value)||y},s=t("field_totalParcels",200),a=t("field_parcelsPending",50),l=Math.max(0,s-a),o=t("field_docsReq",200),i=t("field_docsPending",50),d=Math.max(0,o-i),c=o>0?Math.min(100,Math.max(0,d/o*100)):0,f=t("field_compCases",10),p=e("field_compAmount",10),v=Math.min(100,e("field_compDisbursed",50));return{project_type:n("field_projectType","Highway"),land_type:n("field_landType","Mixed"),priority:n("field_priority","Normal"),current_stage:"Survey",complexity_score:e("field_complexity",40),total_parcels:s,parcels_pending:a,parcels_acquired:l,affected_families:e("field_affectedFamilies",50),land_area_hectares:e("field_landArea",100),planned_duration_days:t("field_plannedDuration",600),days_since_notification:30,days_elapsed:30,days_in_current_stage:30,planned_stage_duration_days:30,schedule_variance_days:parseFloat((r=document.getElementById("field_schedVariance"))==null?void 0:r.value)||0,milestones_due:2,milestones_completed:1,milestones_overdue:t("field_milestonesOverdue",0),acquisition_progress_pct:Math.min(100,e("field_acqProgress",50)),acquisition_velocity_pct_per_30d:e("field_velocity",5),possession_progress_pct:Math.min(100,(1-t("field_possessionPending",50)/Math.max(1,s))*100),possession_pending_parcels:t("field_possessionPending",50),compensation_total_amount:p*1.5,compensation_assessed_amount:p*1.2,compensation_disbursed_amount:p*.5,compensation_pending_amount:p,compensation_completion_pct:v,compensation_pending_cases:f,avg_compensation_delay_days:f*.5,documents_required:o,documents_verified:d,documents_pending:i,documentation_completion_pct:c,approvals_required:10,approvals_completed:5,approvals_pending:t("field_apprPending",2),approval_completion_pct:50,avg_approval_delay_days:e("field_apprDelay",10),overdue_approvals:t("field_apprOverdue",0),active_legal_disputes:t("field_activeDisputes",0),resolved_legal_disputes:0,ownership_disputes:t("field_ownerDisputes",0),court_stay_cases:t("field_courtStays",0),pending_objections:t("field_pendingObj",0),families_requiring_rr:t("field_rrPending",0)+10,families_rr_completed:10,rr_completion_pct:Math.min(100,e("field_rrCompletion",50)),rr_pending_cases:t("field_rrPending",0),pending_stakeholder_actions:t("field_shActions",0),avg_stakeholder_response_days:e("field_shResponse",10),stakeholder_responsiveness_score:e("field_shScore",5),interdepartmental_pending_actions:2,historical_avg_delay_days:e("field_histDelay",50)}}async function k(e){const t=e.querySelector("#loadingOverlay"),n=e.querySelector("#runPredictionBtn");t&&t.classList.remove("hidden"),n&&(n.disabled=!0,n.classList.add("opacity-70","cursor-not-allowed"));try{const s=z(),a=await T.predictRisk(s);I.lastPrediction=a,J(e,a)}catch(s){console.error("Prediction failed:",s),X(e,s.message)}finally{t&&t.classList.add("hidden"),n&&(n.disabled=!1,n.classList.remove("opacity-70","cursor-not-allowed"))}}function J(e,t){const n=t.delay_probability_pct!==void 0?t.delay_probability_pct:t.delay_probability!==void 0?t.delay_probability*100:0,s=typeof n=="number"&&!isNaN(n)?n:0,a=x(s),l=F(a),o=$(a),i=G(a),d=e.querySelector("#probabilityValue"),c=e.querySelector("#probabilityCircle"),f=e.querySelector("#decisionOutcome"),p=e.querySelector("#riskBadge"),v=e.querySelector("#riskSummaryText"),r=e.querySelector("#riskThresholdNote");d&&(d.textContent=`${s.toFixed(2)}%`),f&&(f.textContent=l,f.className=`mt-1 font-label-sm text-[11px] font-semibold ${j(a)}`),v&&(v.textContent=o),r&&(r.textContent=i);const m=301.59,y=m-m*(Math.min(100,Math.max(0,s))/100);c&&(c.style.strokeDashoffset=y,c.className=`transition-all duration-700 ease-out ${U(a)}`),p&&(p.textContent=`${a} RISK`,p.className=`px-space-sm py-1 rounded font-label-sm text-label-sm font-bold uppercase tracking-wider border ${R(a)}`);const b=e.querySelector("#riskIncreasingContainer");if(b){const g=t.risk_drivers||[];if(g.length===0)b.innerHTML=`
      ...
      `;else{const w=Math.max(...g.map(u=>Math.abs(u.contribution)),.1);b.innerHTML=g.map(u=>{const S=Math.min(100,Math.max(15,Math.abs(u.contribution)/w*100)),B=u.contribution>.4?"bg-error":"bg-secondary-container";return`
          <div class="flex flex-col gap-1 border-b border-surface-container-high/40 pb-2 last:border-none">
            <div class="flex items-center justify-between font-label-sm text-label-sm">
              <span class="text-on-surface font-semibold">${u.factor}: <span class="font-bold text-on-surface font-tabular-data">${u.value??"--"}</span></span>
              <span class="font-tabular-data font-bold text-error">+${u.contribution.toFixed(4)}</span>
            </div>
            <div class="w-full bg-surface-container-high rounded-full h-2 overflow-hidden">
              <div class="${B} h-full rounded-full transition-all duration-700" style="width: ${S.toFixed(0)}%;"></div>
            </div>
            <span class="font-body-sm text-[11px] text-on-surface-variant italic">
              <strong>Action:</strong> ${u.recommendation||"Prioritize verification and monitoring."}
            </span>
          </div>
        `}).join("")}}const h=e.querySelector("#riskReducingContainer");if(h){const g=t.risk_reducing_factors||[];if(g.length===0)h.innerHTML=`
        <div class="text-on-surface-variant font-body-sm text-sm italic py-2">
          No significant risk-reducing factors detected.
        </div>
      `;else{const w=Math.max(...g.map(u=>Math.abs(u.contribution)),.1);h.innerHTML=g.map(u=>{const S=Math.min(100,Math.max(15,Math.abs(u.contribution)/w*100));return`
          <div class="flex flex-col gap-1 border-b border-surface-container-high/40 pb-2 last:border-none">
            <div class="flex items-center justify-between font-label-sm text-label-sm">
              <span class="text-on-surface font-medium">${u.factor}: <span class="font-bold text-on-surface font-tabular-data">${u.value??"--"}</span></span>
              <span class="font-tabular-data font-semibold text-emerald-600">${u.contribution.toFixed(4)}</span>
            </div>
            <div class="w-full bg-surface-container-high rounded-full h-2 overflow-hidden">
              <div class="bg-emerald-600 h-full rounded-full transition-all duration-700" style="width: ${S.toFixed(0)}%;"></div>
            </div>
          </div>
        `}).join("")}}const A=e.querySelector("#directivesContainer");if(A){const g=t.risk_drivers||[];g.length>0?A.innerHTML=g.slice(0,2).map((w,u)=>`
          <div class="p-space-sm bg-surface-container-low rounded-lg flex items-start gap-space-sm border border-outline-variant/30">
            <span class="px-1.5 py-0.5 rounded ${u===0?"bg-error text-on-error":"bg-secondary text-on-secondary"} font-label-sm text-[10px] font-bold shrink-0 mt-0.5">${u===0?"P1 PRIORITY":"P2 PRIORITY"}</span>
            <div class="flex flex-col">
              <span class="font-label-sm text-label-sm font-bold text-on-surface">${w.factor} Resolution</span>
              <p class="font-body-sm text-[12px] text-on-surface-variant mt-0.5">${w.recommendation}</p>
            </div>
          </div>
        `).join(""):A.innerHTML=`
      ...
      `}}function X(e,t){const n=e.querySelector("#riskIncreasingContainer"),s=t&&!t.includes("uvicorn")?t:"Prediction service is temporarily unavailable. Please try again.";if(n){n.innerHTML=`
    ...
    `;const a=n.querySelector("#retryPredictionBtn");a&&a.addEventListener("click",()=>k(e))}}function Q(e,t,n){e.innerHTML=`
  ...
  `;const s=e.querySelector("#directoryTableBody"),a=e.querySelector("#directorySearchInput"),l=e.querySelector("#filterSector"),o=e.querySelector("#filterRisk"),i=()=>{const c=((a==null?void 0:a.value)||"").toLowerCase().trim(),f=(l==null?void 0:l.value)||"all",p=(o==null?void 0:o.value)||"all",v=P.filter(r=>{const m=r.id.toLowerCase().includes(c)||r.name.toLowerCase().includes(c)||r.district.toLowerCase().includes(c)||r.state.toLowerCase().includes(c),y=f==="all"||r.type===f,b=p==="all"||r.riskLevel===p;return m&&y&&b});if(v.length===0){s.innerHTML='<tr><td colspan="8" class="text-center py-6 text-on-surface-variant">No matching records found in national database.</td></tr>';return}s.innerHTML=v.map(r=>`
      <tr class="hover:bg-surface-container-low/70 transition-colors">
        ...
        <td class="py-space-md px-space-md font-tabular-data font-bold ${j(r.riskLevel||x(r.delayProbability))}">${r.delayProbability}%</td>
        <td class="py-space-md px-space-md">
          <span class="px-2 py-0.5 rounded-full ${R(r.riskLevel||x(r.delayProbability))} font-label-sm text-xs font-bold border">${r.riskLevel||x(r.delayProbability)}</span>
        </td>
    ...
    `).join(""),s.querySelectorAll(".dir-assess-btn").forEach(r=>{r.addEventListener("click",()=>{const m=r.getAttribute("data-preset");t&&t(m)})}),s.querySelectorAll(".dir-audit-btn").forEach(r=>{r.addEventListener("click",()=>{const m=r.getAttribute("data-id");n&&n(m)})})};a&&a.addEventListener("input",i),l&&l.addEventListener("change",i),o&&o.addEventListener("change",i);const d=e.querySelector("#newAssessmentBtn");d&&t&&d.addEventListener("click",()=>t("medium")),i()}function Y(e,t="BF-NH-2024-09",n){const s=P.find(i=>i.id===t)||P[0],a=x(s.delayProbability);e.innerHTML=`
    <div class="flex flex-col w-full">
        ...
        <div class="w-full bg-surface-container-lowest rounded-xl shadow-sm overflow-hidden grid grid-cols-1 lg:grid-cols-12 border border-outline-variant/30">
          ...
          <div class="lg:col-span-4 ${a==="CRITICAL"?"bg-error-container/40":a==="HIGH"?"bg-orange-50 dark:bg-orange-950/40":a==="MEDIUM"?"bg-amber-50 dark:bg-amber-950/40":"bg-emerald-50 dark:bg-emerald-950/40"} p-space-xl flex flex-col justify-between relative overflow-hidden">
            <div class="flex flex-col gap-space-md relative z-10">
              <div class="flex items-center justify-between">
                <span class="px-space-xs py-1 rounded ${R(a)} font-label-sm text-label-sm font-bold uppercase tracking-wider flex items-center gap-1.5 shadow-sm border">
              ...
              <div class="flex flex-col pt-space-xs">
                ...
                <div class="flex items-baseline gap-space-xs">
                  <span class="font-headline-xl text-headline-xl font-tabular-data ${j(a)} font-extrabold tracking-tight">${s.delayProbability}%</span>
  ...
  `;const l=e.querySelector("#detailRerunBtn");l&&n&&l.addEventListener("click",()=>n(s.presetKey||"medium"));const o=e.querySelector("#backToProjectsBreadcrumb");o&&o.addEventListener("click",()=>{window.location.hash="#/projects"})}class Z{constructor(){this.container=document.getElementById("appViewContainer"),this.currentView="dashboard",this.isBackendOnline=!1,this.healthInterval=null,this.clockInterval=null}init(){this.setupNavigation(),this.setupClock(),this.startHealthPolling(),this.handleRouting(),window.addEventListener("hashchange",()=>this.handleRouting());const t=document.getElementById("brandHeaderHome");t&&t.addEventListener("click",()=>{window.location.hash="#/dashboard"});const n=document.getElementById("backendStatusPill");n&&n.addEventListener("click",()=>this.checkBackendHealth(!0))}setupNavigation(){const t=document.querySelectorAll(".nav-tab");t.forEach(n=>{n.addEventListener("click",s=>{t.forEach(a=>{a.className="nav-tab px-space-md py-1.5 font-label-md text-label-md text-on-surface-variant hover:text-on-surface hover:bg-surface-container transition-colors rounded",a.removeAttribute("aria-current")}),n.className="nav-tab px-space-md py-1.5 transition-colors bg-primary-container text-on-primary font-label-md rounded-lg shadow-sm font-semibold",n.setAttribute("aria-current","page")})})}updateNavState(t){document.querySelectorAll(".nav-tab").forEach(l=>{l.getAttribute("data-target")===t?(l.className="nav-tab px-space-md py-1.5 transition-colors bg-primary-container text-on-primary font-label-md rounded-lg shadow-sm font-semibold",l.setAttribute("aria-current","page")):(l.className="nav-tab px-space-md py-1.5 font-label-md text-label-md text-on-surface-variant hover:text-on-surface hover:bg-surface-container transition-colors rounded",l.removeAttribute("aria-current"))});const s={dashboard:"National Cadastral Matrix (Overview)",assessment:"Predictive Delay-Risk Assessment Cockpit",projects:"National Land Acquisition Projects Directory",audit:"Cadastral & Risk Detailed Dossier"},a=document.getElementById("currentViewName");a&&(a.textContent=s[t]||"Executive Command Center")}handleRouting(){const t=window.location.hash||"#/dashboard",[n,s]=t.replace("#/","").split("?"),a=new URLSearchParams(s||"");switch(this.currentView=n||"dashboard",this.updateNavState(this.currentView),window.scrollTo({top:0,behavior:"smooth"}),this.currentView){case"assessment":const l=a.get("preset")||"medium";W(this.container,l);break;case"projects":Q(this.container,i=>{window.location.hash=`#/assessment?preset=${i}`},i=>{window.location.hash=`#/audit?id=${i}`});break;case"audit":const o=a.get("id")||"BF-NH-2024-09";Y(this.container,o,i=>{window.location.hash=`#/assessment?preset=${i}`});break;case"dashboard":default:this.currentView="dashboard",V(this.container,i=>{window.location.hash=`#/assessment?preset=${i}`},i=>{window.location.hash=`#/audit?id=${i}`});break}}setupClock(){const t=()=>{const n=document.getElementById("liveISTClock");if(n){const s=new Date,a={timeZone:"Asia/Kolkata",hour12:!1,hour:"2-digit",minute:"2-digit",second:"2-digit"};n.textContent=s.toLocaleTimeString("en-GB",a)}};t(),this.clockInterval=setInterval(t,1e3)}async checkBackendHealth(t=!1){var l,o;const n=document.getElementById("backendStatusDot"),s=document.getElementById("backendStatusText");n&&(n.innerHTML='<span class="animate-pulse relative inline-flex rounded-full h-2 w-2 bg-amber-400"></span>'),s&&!this.isBackendOnline&&(s.textContent="Backend: Connecting...",s.className="font-label-sm text-label-sm text-on-surface-variant font-tabular-data");const a=await T.checkHealth();if(a.online&&a.modelLoaded){let i="FastAPI Connected • XGBoost Engine Active";try{this.cachedMetadata||(this.cachedMetadata=await T.getMetadata()),(o=(l=this.cachedMetadata)==null?void 0:l.model)!=null&&o.version&&(i=`FastAPI Connected • XGBoost Engine v${this.cachedMetadata.model.version} Active`)}catch{}n&&(n.innerHTML=`
          <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
          <span class="relative inline-flex rounded-full h-2 w-2 bg-emerald-600"></span>
        `),s&&(s.textContent=i,s.className="font-label-sm text-label-sm text-on-surface font-tabular-data font-semibold"),!this.isBackendOnline&&t&&this.showToast("Backend connected: XGBoost binary classifier loaded.","success"),this.isBackendOnline=!0}else n&&(n.innerHTML=`
          <span class="relative inline-flex rounded-full h-2 w-2 bg-red-500"></span>
        `),s&&(s.textContent="Backend Unavailable • Click to Retry",s.className="font-label-sm text-label-sm text-red-600 dark:text-red-400 font-tabular-data font-semibold"),(this.isBackendOnline||t)&&this.showToast("Prediction service is temporarily unavailable. Please try again.","warning"),this.isBackendOnline=!1}startHealthPolling(){this.checkBackendHealth(),this.healthInterval=setInterval(()=>this.checkBackendHealth(),6e3)}showToast(t,n="info"){const s=document.getElementById("toastContainer");if(!s)return;const a=document.createElement("div"),l=n==="success"?"bg-primary-container text-on-primary border-secondary":"bg-amber-100 text-amber-950 border-amber-400";a.className=`${l} px-4 py-3 rounded-lg shadow-lg border text-sm max-w-md pointer-events-auto flex items-start gap-2 transition-all duration-300 transform translate-y-2 opacity-0`,a.innerHTML=`
      <span class="material-symbols-outlined text-[18px] text-secondary-container mt-0.5">info</span>
      <span class="flex-1">${t}</span>
    `,s.appendChild(a),requestAnimationFrame(()=>{a.classList.remove("translate-y-2","opacity-0")}),setTimeout(()=>{a.classList.add("opacity-0","translate-y-2"),setTimeout(()=>a.remove(),300)},4500)}}document.addEventListener("DOMContentLoaded",()=>{new Z().init()});
